...
class InternalAddressesMigrationService {
	...
	public const ESTIMATED_INTERNAL_ADDRESS_SIZE = 120;
	...
	public function getEstimatedExportSize(IUser $user): int {
		return count($this->internalAddressService->getInternalAddresses($user->getUID())) * self::ESTIMATED_INTERNAL_ADDRESS_SIZE;
	}
