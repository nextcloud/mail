...
class HtmlTest extends \PHPUnit_Framework_TestCase {
	...
	public function linkDetectionProvider() {
		return array(
			...
			array('<a href="https://ci.owncloud.org/job/ownCloud-Documentation(7.0)/504/changes" target="_blank" rel="noreferrer">https://ci.owncloud.org/job/ownCloud-Documentation(7.0)/504/changes</a>', 'https://ci.owncloud.org/job/ownCloud-Documentation(7.0)/504/changes'),
			array('<a href="https://communities.coverity.com/community/scan-(open-source)/content" target="_blank" rel="noreferrer">https://communities.coverity.com/community/scan-(open-source)/content</a>', 'https://communities.coverity.com/community/scan-(open-source)/content'),
			array('<a href="https://ma.ellak.gr/events/5ος-εκπαιδευτικός-κύκλος-σεμιναρίων-ε-5/" target="_blank" rel="noreferrer">https://ma.ellak.gr/events/5ος-εκπαιδευτικός-κύκλος-σεμιναρίων-ε-5/</a>', 'https://ma.ellak.gr/events/5ος-εκπαιδευτικός-κύκλος-σεμιναρίων-ε-5/'),
		);
	}
