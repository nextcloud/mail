...
class QuickActionsMigrationServiceTest extends TestCase {
	...
	public static function provideIncompleteMappings(): array {
		return [
			...
			'no mailboxes imported' => ['accountMapping' => self::ACCOUNT_MAPPING, 'mailboxMapping' => []],
	 ...
	 */
	public function testImportWithoutAccountOrMailboxMappingIsSkipped(array $accountMapping,
