...
class TextBlocksMigrationServiceTest extends TestCase {
	...
	public function testEstimatedExportSizeMeasuresTheContent(): void {
		$textBlock = new TextBlock();
		$textBlock->setTitle('Greeting');
		$textBlock->setContent(str_repeat('a', 5000));
		$textBlock->setPreview('Hi');
		...
		self::assertSame(TextBlocksMigrationService::ESTIMATED_TEXT_BLOCK_SIZE + 8 + 5000 + 2, $size);
	}
