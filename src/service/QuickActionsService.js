...
export async function fetchAllQuickActions() {
	const url = generateUrl('/apps/mail/api/quickActions')
...
export async function updateQuickAction(id, name) {
	const url = generateUrl('/apps/mail/api/quickActions/{id}', { id })
	return handleHttpAuthErrors(async () => {
...
export async function findAllStepsForAction(actionId) {
	const url = generateUrl('/apps/mail/api/actionStep/{id}/steps', { id: actionId })
	return handleHttpAuthErrors(async () => {
		const response = await axios.get(url)
		return response.data.data
	})
...
export async function createActionStep(name, order, actionId, tagId = null, mailboxId = null) {
	const url = generateUrl('/apps/mail/api/actionStep')
	return handleHttpAuthErrors(async () => {
...
export async function updateActionStep(id, name, order, tagId, mailboxId) {
	const url = generateUrl('/apps/mail/api/actionStep/{id}', { id })
	return handleHttpAuthErrors(async () => {
...
export function swapOrder(id, newOrder) {
	const url = generateUrl('/apps/mail/api/actionStep/{id}/order', { id })
	return handleHttpAuthErrors(async () => {
