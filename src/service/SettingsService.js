...
export const setAntiSpamEmail = (spam, spamSubject, ham, hamSubject) => {
	return axios.post(generateUrl('/apps/mail/api/settings/antispam'), { data: { spam, spamSubject, ham, hamSubject } })
		.then((resp) => resp.data)
}
