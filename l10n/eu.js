OC.L10N.register(
    ...
    "We couldn’t load {tag}{name}{endtag}" : "Ezin izan dugu {tag}{name}{endtag} kargatu",
    "There was a problem loading {tag}{name}{endtag}" : "Akats bat egon da {tag}{name}{endtag} kargatzerakoan",
    "We couldn’t load your message" : "Ezin izan dugu zure mezua kargatu",
    "Unable to load the desired message" : "Ezin izan da eskatutako mezua kargatu",
    "There was a problem loading the message" : "Arazoren bat egon da mezua kargatzerakoan",
    "{from}\n{subject}" : "{from}\n{subject}",
