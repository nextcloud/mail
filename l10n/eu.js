OC.L10N.register(
    ...
    "_Move {number}_::_Move {number}_" : ["Mugitu {number}","Mugitu {number} "],
    ...
    "_Delete {number}_::_Delete {number}_" : ["Ezabatu {number}","Ezabatu {number}"],
    ...
    "Successfully provisioned {count} accounts." : "{count} kontuak behar bezala hornitu dira.",
