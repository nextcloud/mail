OC.L10N.register(
    ...
    "You are currently using {percentage} of your mailbox storage. Please make some space by deleting unneeded emails." : "سىز ھازىر خەت ساندۇقىڭىزنىڭ {percentage} using نى ئىشلىتىۋاتىسىز. كېرەكسىز ئېلېكترونلۇق خەتلەرنى ئۆچۈرۈپ بىر ئاز بوشلۇق قالدۇرۇڭ.",
    ...
    "Always show images from {sender}" : "ھەمىشە {sender} from دىن رەسىملەرنى كۆرسىتىڭ",
    "Always show images from {domain}" : "ھەمىشە {domain} from دىكى رەسىملەرنى كۆرسىتىڭ",
