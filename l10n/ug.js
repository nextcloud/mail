OC.L10N.register(
    ...
    "{usage} of {limit} used" : "{usage} of {limit} ئىشلىتىلگەن",
    "Remove account" : "ھېساباتنى ئۆچۈرۈڭ",
    "The account for {email} and cached email data will be removed from Nextcloud, but not from your email provider." : "{email} خەت} ۋە غەملەك ئېلېكترونلۇق خەت سانلىق مەلۇماتلىرىنىڭ ھېساباتى Nextcloud دىن ئۆچۈرۈلىدۇ ، ئەمما ئېلېكترونلۇق خەت تەمىنلىگۈچىڭىزدىن ئۆچۈرۈلمەيدۇ.",
