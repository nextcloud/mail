OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!\n\n## Ethical AI Rating\n\n### Priority Inbox\n\nPositive:\n* The software for training and inferencing of this model is open source.\n* The model is created and trained on-premises based on the user's own data.\n* The training data is accessible to the user, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Thread Summaries (opt-in)\n\n**Rating:** 🟢/🟡/🟠/🔴\n\nThe rating depends on the installed text processing backend. See [the rating overview](https://docs.nextcloud.com/server/latest/admin_manual/ai/index.html) for details.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "**💌 Nextcloud용 메일 앱**\n\n- **🚀 다른 Nextcloud 앱과 통합하세요!** 현재 Contacts, Calendar, Files 앱을 지원하며 계속 확대될 예정입니다.\n- **📥 여러 개의 메일 계정을 등록하세요!** 개인 계정과 회사 계정을 따로 관리하십니까? 문제 없이 지원하며, 통합 받은 편지함에 수신됩니다. IMAP 계정에 마음껏 연결하세요!\n- **🔒 암호화된 이메일을 보내고 받으세요!** 믿음직한 [Mailvelope](https://mailvelope.com) 브라우저 확장기능을 사용하십시오.\n- **🙈 뿌리부터 새로 만든 것은 아닙니다!** [Horde](https://horde.org) 라이브러리를 사용합니다.\n- **📬 자체 메일 서버를 호스트 하고 싶으신가요?** [Mail-in-a-Box](https://mailinabox.email)를 설정할 수 있습니다!\n\n## AI 윤리 등급\n\n### 우선 편지함\n\n긍정적:\n* 해당 모델의 학습과 추론 소프트웨어가 오픈소스임.\n* 해당 모델은 사용자 데이터에 기반하여 온프레미스(on-premise)로 생성, 학습됨.\n* 사용자는 학습 정보에 접근할 수 있으며, 이를 통해 편향을 확인 및 교정하거나 성능과 CO2 소비를 최적화할 수 있음.\n\n### 쓰레드 요약 (opt-in 방식)\n\n**등급:** 🟢/🟡/🟠/🔴\n\n평가 결과는 설치된 텍스트 처리 백엔드를 따릅니다. 자세한 정보는 [평가 개요](https://docs.nextcloud.com/server/latest/admin_manual/ai/index.html)를 참조하십시오.\n\nNextcloud AI 윤리 등급에 대한 자세한 정보는 [블로그](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)  를 참조하십시오.",
    ...
    "Activate body search" : "본문 검색 활성화",
    ...
    "Toggle recipients list mode" : "받는이 목록 모드 전환",
    "Cc" : "참조",
    "Bcc" : "숨은참조",
    "Subject" : "제목",
    "Subject …" : "제목...",
    ...
    "_Delete {number} thread_::_Delete {number} threads_" : ["쓰레드 {number} 삭제"],
    ...
    "This event is in the past." : "이미 지나간 일정입니다.",
    ...
    "Disabled" : "비활성화됨",
    "Enabled" : "활성화됨",
    "Sieve Host" : "Sieve 호스트",
    "Sieve Security" : "Sieve 보안",
    "Sieve Port" : "Sieve 포트",
    "Sieve Credentials" : "Sieve 인증 정보",
    "IMAP Credentials" : "IMAP 인증 정보",
    "Custom" : "사용자 정의",
    ...
    "Enable thread summary" : "쓰레드 요약 활성화",
    "Enable thread summaries" : "쓰레드 요약 활성화",
    "Enable smart replies" : "스마트 답장 활성화",
