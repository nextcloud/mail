OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!\n\n## Ethical AI Rating\n### Rating: 🟢\n\nPositive:\n* The software for training and inferencing of this model is open source.\n* The model is created and trained on-premises based on the user's own data.\n* The training data is accessible to the user, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "**💌 Una aplicación de correo para Nextcloud**\n      \n      - **🚀 Integración con otras aplicaciones de Nextcloud.** Actualmente Contactos, Calendario y Archivos; ¡más por venir!\n      - **📥 Múltiples cuentas de correo.** ¿Cuenta personal y de empresa? No hay problema, y una bandeja de entrada unificada. Conecta cualquier cuenta IMAP.\n      - **🔒 Enviar y recibir correos cifrados.** Usando la excelente extensión del navegador [Mailvelope](https://mailvelope.com).\n      - **🙈 ¡No estamos reinventando la rueda!** Basado en las excelentes bibliotecas de [Horde](https://horde.org).\n      - **📬 ¿Quieres alojar tu propio servidor de correo?** No necesitamos reinventar esto, ya que puedes configurar [Mail-in-a-Box](https://mailinabox.email).\n      \n      ## Calificación de IA ética\n      ### Calificación: 🟢\n      \n      Positivo:\n      * El software para entrenar e inferir este modelo es de código abierto.\n      * El modelo se crea y entrena localmente basado en los propios datos del usuario.\n      * Los datos de entrenamiento son accesibles para el usuario, lo que permite verificar o corregir sesgos, optimizar el rendimiento y el uso de CO2.\n      \n      Aprende más sobre la Calificación de IA ética de Nextcloud [en nuestro blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    ...
    "Account created. Please follow the popup instructions to link your Google account" : "Cuenta creada. Sigue las instrucciones emergentes para vincular tu cuenta de Google",
    "Loading account" : "Cargando cuenta",
    "Account updated. Please follow the popup instructions to reconnect your Google account" : "Cuenta actualizada. Sigue las instrucciones emergentes para reconectar tu cuenta de Google",
