OC.L10N.register(
    ...
    "Enable Mailvelope for the current domain" : "Habiliteu Mailvelope per al domini actual",
    ...
    "Select certificates" : "Seleccioneu certificats",
    ...
    "Add share link from Files" : "Afegeix un enllaç per compartir des de Fitxers",
    ...
    "Collapse composer" : "Col·lapse el compositor",
    ...
    "Enable sieve filter" : "Activa el filtre de Sieve",
    ...
    "Disable reminder" : "Desactiva el recordatori",
    ...
    "Are you sure to delete the mail filter?" : "Esteu segur que suprimiu el filtre de correu?",
    ...
    "Priority" : "Prioritat",
    "Enable filter" : "Activa el filtre",
    "Save filter" : "Desa el filtre",
    ...
    "Enable text processing through LLMs" : "Habilita el processament de text mitjançant LLM",
    ...
    "Enable LLM processing" : "Activa el processament de LLM",
    "Enable classification by importance by default" : "Activa la classificació per importància de manera predeterminada",
    "The Mail app can classify incoming emails by importance using machine learning. This feature is enabled by default but can be disabled by default here. Individual users will still be able to toggle the feature for their accounts." : "L'aplicació Mail pot classificar els correus electrònics entrants per importància mitjançant l'aprenentatge automàtic. Aquesta funció està activada per defecte, però es pot desactivar aquí. Els usuaris individuals encara podran canviar la funció dels seus comptes.",
    "Enable classification of important mails by default" : "Activa la classificació de correus importants de manera predeterminada",
