OC.L10N.register(
    ...
    "Defaults" : "Oletukset",
    "Here you can select where Nextcloud Mail stores your drafts as well as sent and deleted messages." : " Tässä voit valita minne Nextcloud Sähköposti tallettaa luonnoksesi sekä lähetetyt ja poistetut viestisi.",
    "Draft messages are saved to:" : "Luonnokset tallennetaan sijaintiin:",
    "Sent messages are saved to:" : "Lähetetyt viestit tallennetaan sijaintiin:",
    "Deleted messages are moved to:" : "Poistetut viestit tallennetaan sijaintiin:",
    "Auto" : "Automaattinen",
    "Name" : "Nimi",
    ...
    "Mark {number} unread" : "Merkkaa {number} lukemattomiksi",
    "Mark {number} read" : "Merkkaa {number} luetuiksi",
    "Favorite {number}" : "Merkkaa {number} suosikeiksi",
    "Move {number}" : "Siirrä {number} viestiä",
    "Delete {number}" : "Poista {number} viestiä",
