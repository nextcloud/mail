OC.L10N.register(
    ...
    "Newest" : "Uusimmat",
    "Oldest" : "Vanhimmat",
    "Search in body" : "Etsi sisällöstä",
    "Gravatar settings" : "Gravatar-asetukset",
    ...
    "Create a new text block" : "Luo uusi tekstilohko",
    "Shared with me" : "Jaettu kanssasi",
    "Privacy and security" : "Yksityisyys ja turvallisuus",
    "Data collection consent" : "Datakeruun suostumus",
    ...
    "Step 1: Install Mailvelope browser extension" : "Vaihe 1: Asenna Mailvelope-selainlaajennus",
    "Step 2: Enable Mailvelope for the current domain" : "Vaihe 2: Ota Mailvelope käyttöön nykyiselle verkkotunnukselle",
    "About" : "Tietoja",
    ...
    "contains" : "sisältää",
    "matches" : "täsmää",
    "Update mail filter" : "Päivitä viestisuodatin",
    "Filter name" : "Nimisuodatin",
    "If all the conditions are met" : "jos kaikki ehdot ovat tosia",
    "If any of the conditions are met" : "jos yksi ehdoista on tosi",
    "Add condition" : "Lisää ehto",
    "Then perform these actions" : "Sitten suorita nämä toiminnot",
    "Moves the message into a specified folder." : "Siirtää viestin haluttuun kansioon.",
