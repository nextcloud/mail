OC.L10N.register(
    ...
    "_Move {number}_::_Move {number}_" : ["Premjesti {number}","Premjesti {number}","Premjesti {number}"],
    ...
    "_Delete {number}_::_Delete {number}_" : ["Izbriši {number}","Izbriši {number}","Izbriši {number}"],
