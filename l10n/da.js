OC.L10N.register(
    ...
    "Account created. Please follow the pop-up instructions to link your Microsoft account" : "Konto oprettet. Følg venligst instruktionerne i popup'en for at linke din Microsoftkonto",
    ...
    "Account updated. Please follow the pop-up instructions to reconnect your Microsoft account" : "Konto opdateret. Følg venligst instruktionerne i popup'en for at genforbinde din Microsoftkonto",
    ...
    "Show only the selected message" : "Vis kun de valgte beskeder",
    "Sorting" : "Sortering",
    "Newest" : "Nyeste",
    "Oldest" : "Ældste",
    ...
    "Update Certificate" : "Opdater certifikat",
    ...
    "Archive message" : "Arkiver besked",
    ...
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Marker {number} som spam","Marker {number} som spam"],
    "_Mark {number} as not spam_::_Mark {number} as not spam_" : ["Marker {number} som ikke spam","Marker {number} som ikke spam"],
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Rediger tags for {number}","Rediger tags for {number}"],
    ...
    "Mark as unimportant" : "Marker som ikke vigtig",
    ...
    "Load more important messages" : "Indlæse flere vigtige beskeder",
    "Other" : "Andet",
    "Load more other messages" : "Indlæse flere andre beskeder",
    ...
    "Edit absence settings" : "Rediger fraværsindstillinger",
    ...
    "Copy to \"Sent\" Folder" : "Kopier til mappen \"Sendt\"",
    "Copy to Sent Folder" : "Kopier til mappen Sendt",
    "Hide suspicious links" : "Gem mistænkelige links",
    "Show suspicious links" : "Vis mistænkelige links",
    "link text" : "linktekst",
    "Copied email address to clipboard" : "Kopierede e-mailadresse til udklipsholder",
    "Could not copy email address to clipboard" : "Kunne ikke kopiere e-mailadresse til udklipsholder",
    ...
    "Open search modal" : "Åben søgemodal",
    "Close" : "Luk",
    ...
    "From me" : "Fra mig",
    "Enable mail body search" : "Aktiver søgning i mailhovedtekst",
    ...
    "Disable reminder" : "Deaktiver påmindelse",
    "Reply to sender only" : "Besvar kun afsender",
    "Go to latest message" : "Gå til sidste besked",
