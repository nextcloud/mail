OC.L10N.register(
    ...
    "The selected certificate is not trusted by the server. Recipients might not be able to verify your signature." : "الشهادة المحددة غير موثوق بها من قِبَل الخادوم. قد لا يتمكن المستلمون من التحقُّق من توقيعك.",
    ...
    "Confirm" : "تأكيد",
    "The tag will be deleted from all messages." : "سوف يتم حذف السِّمَة tag من جميع الرسائل.",
    ...
    "Copy to \"Sent\" Mailbox" : "النسخ إلى صندوق البريد \"الصادر Send\"",
    "Copy to Sent Mailbox" : "النسخ إلى صندوق البريد الصادر Send ",
    "Could not copy to \"Sent\" mailbox" : "تعذّر النسخ إلى صندوق البريد \"الصادر Send\"",
    ...
    "Not found" : "غير موجود",
    "Summarizing thread failed." : "إخفاق في تلخيص النَّظْمَة Thread",
    ...
    "Thread Summary" : "مُلخّص النَّظْمَة Thread ",
