OC.L10N.register(
    ...
    "Mail" : "البريد",
    "Defaults" : "الافتراضي",
    "Here you can select where Nextcloud Mail stores your drafts as well as sent and deleted messages." : "من هنا تستطيع تحديد مكان تخزين المسودات في Nextcloud Mail وايضا المرسلات والرسائل المحذوفه.",
    "Draft messages are saved to:" : "المسودات سيتم حفظها في:",
    "Sent messages are saved to:" : "الرسائل المرسلة يتم تخزينها في:",
    "Deleted messages are moved to:" : "الرسائل المحذوفه سيتم نقلها إلى:",
    "Name" : "الإسم",
