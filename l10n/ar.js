OC.L10N.register(
    ...
    "We couldn’t load your message" : "لم نتمكن من تحميل رسالتك",
    "Unable to load the desired message" : "لا يمكن تحميل الرسالة المطلوبة",
    "There was a problem loading the message" : "هناك خطأ ما عند تحميل الرسالة",
    "{from}\n{subject}" : "{from}\n{subject}",
