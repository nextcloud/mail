OC.L10N.register(
    ...
    "Mail server configuration mode" : "E-postiserveri seadistusrežiim",
    "Auto" : "Automaatne",
    "Manual" : "Käsitsi",
    "Name" : "Nimi",
    ...
    "Select a mailbox" : "Vali postkast",
    "Choose" : "Vali",
    ...
    "Redirect to" : "Suuna edasi aadressile",
    "Stop" : "Lõpeta",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "Kirjade edasisuunamisel võib postiserver nad tagasi lükata ja kui kiri on krüptitud, siis ta ei pruugi olla uue saaja jaoks loetav.",
    "Priority" : "Olulisus",
    ...
    "Using master user and master password" : "Kasutusel on üldkasutaja ja üldsalasõna",
    "Using master password for all users" : "Kõikide kasutajate jaoks on kasutusel üldsalasõna",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Ilma üldkasutajata kõik kasutajad autenditakse nende tavalise kasutajanimega ja selle üldsalasõnaga.",
    "Master user" : "Üldkasutaja",
    "e.g. {example}" : "nt. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Lisatud kasutajanimele. Peab algama sama eraldajaga, nagu „{setting}“ seadistus Dovecotis.",
    "Sieve" : "Sieve",
    ...
    "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute" : "* %USERID% ja %EMAIL% asendatakse kasutaja UID-ga ja e-posti aadressiga. {ldapPlaceholder} asendatakse vastava LDAP-i atribuudiga",
