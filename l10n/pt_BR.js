OC.L10N.register(
    ...
    "_Mark {number} as important_::_Mark {number} as important_" : ["Marque {number} como importante","Marque {number} como importante"],
    "_Mark {number} as unimportant_::_Mark {number} as unimportant_" : ["Marque {number} como sem importância ","Marque {number} como sem importância "],
    ...
    "_Move {number} thread_::_Move {number} threads_" : ["Mover {number} tópico","Mover {number} tópicos"],
    "_Forward {number} as attachment_::_Forward {number} as attachment_" : ["Encaminhe {number} como anexo ","Encaminhar {number} como anexo"],
    "_Delete {number} thread_::_Delete {number} threads_" : ["Excluir {number} tópico","Excluir {number} tópicos"],
    ...
    "_Successfully provisioned {count} account._::_Successfully provisioned {count} accounts._" : ["Provisionado com sucesso {count} conta.","Provisionado com sucesso {count} contas."],
    "Anti Spam" : "Anti Spam",
