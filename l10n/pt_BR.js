OC.L10N.register(
    ...
    "These settings are used to pre-configure the user interface preferences they can be overridden by the user in the mail settings" : "Essas configurações são usadas para pré-configurar as preferências da interface do usuário e podem ser substituídas pelo usuário nas configurações de e-mail",
