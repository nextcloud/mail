OC.L10N.register(
    ...
    "Some addresses in this message are not matching the link text" : "Alguns endereços nesta mensagem não correspondem ao texto do link",
    ...
    "Aliases" : "Apelido",
    "Alias to S/MIME certificate mapping" : "Apelido para mapeamento de certificado S/MIME",
    ...
    "The autoresponder uses Sieve, a scripting language supported by many email providers. If you're unsure whether yours does, check with your provider. If Sieve is available, click the button to go to the settings and enable it." : "O autoresponder usa o Sieve, uma linguagem de script suportada por muitos provedores de e-mail. Se não tiver certeza de que o seu usa, verifique com seu provedor. Se o Sieve estiver disponível, clique no botão para acessar as configurações e ativá-lo.",
    "Go to Sieve settings" : "Vá para as configurações do Sieve",
    "Filters" : "Filtros",
    "Sieve script editor" : "Editor de script Sieve",
    ...
    "Use internal addresses" : "Use endereços internos",
    ...
    "Update Certificate" : "Certificado de atualização",
    ...
    "Draft: " : "Rascunho:",
    "This summary was AI generated" : "Esse resumo foi gerado por IA",
    ...
    "Archive thread" : "Arquivar tópico",
    ...
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Editar tags para {number}","Editar tags para {number}","Editar tags para {number}"],
    ...
    "Please wait 10 minutes before repairing again" : "Aguarde 10 minutos antes de reparar novamente",
    ...
    "Collapse composer" : "Recolher o compositor",
    ...
    "Welcome to {productName} Mail" : "Bem-vindo ao {productName} Mail",
    ...
    "Could not copy to \"Sent\" mailbox" : "Não foi possível copiar para a caixa postal \"Enviados\"",
    "Mail server error" : "Erro no servidor de correio",
    "Message could not be sent" : "A mensagem não pôde ser enviada",
    "Message deleted" : "Mensagem excluída",
    "Copy to \"Sent\" Mailbox" : "Copiar para Caixa Postal \"Enviado\"",
    "Copy to Sent Mailbox" : "Copiar para Caixa Postal enviada",
    "Phishing email" : "E-mail de phishing",
    "This email might be a phishing attempt" : "Este email pode ser uma tentativa de golpe",
    ...
    "Select BCC recipients" : "Selecionar destinatários BCC",
    "Tags" : "Etiquetas",
    ...
    "Take control of your email chaos. Filters help you to prioritize what matters and eliminate clutter." : "Assuma o controle do caos do seu email. Os filtros ajudam você a priorizar o que importa e eliminar a desordem.",
    ...
    "A substring match. The field matches if the provided value is contained within it. For example, \"report\" would match \"port\"." : "Uma correspondência de substring. O campo bate se o valor fornecido estiver contido nele. Por exemplo, \"portaria\" bateria com \"porta\".",
    ...
    "New test" : "Novo teste",
    "Actions" : "Ações",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "As ações são executadas quando os testes forem verdadeiros. As seguintes ações estão disponíveis:",
    "Moves the message into a specified folder." : "Move a mensagem para uma pasta especificada.",
    "Adds a flag to the message." : "Adiciona um sinalizador à mensagem.",
    ...
    "Enable LLM processing" : "Habilitar processamento LLM",
    ...
    "Could not create snooze mailbox" : "Não foi possível criar caixa de correio",
    "Message sent" : "Mensagem enviada",
    "Could not send message" : "Não foi possível enviar a mensagem",
    "Message copied to \"Sent\" mailbox" : "Mensagem copiada para a caixa postal \"Enviada\"",
    "Could not copy message to \"Sent\" mailbox" : "Não foi possível copiar a mensagem para a caixa postal \"Enviada\"",
