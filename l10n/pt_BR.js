OC.L10N.register(
    ...
    "Mail server configuration mode" : "Modo de configuração do servidor de e-mail",
    "Auto" : "Automático",
    "Manual" : "Manual",
    "Name" : "Nome",
    ...
    "Select a mailbox" : "Selecione uma caixa de correio",
    "Choose" : "Escolher",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "As mensagens redirecionadas podem ser rejeitadas pelo servidor de destino e, se estiverem criptografadas, não poderão ser lidas pelo destinatário.",
    "Priority" : "Prioridade",
    ...
    "Using master user and master password" : "Usando o usuário geral e a senha geral",
    "Using master password for all users" : "Usando uma senha geral para todos os usuários",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Sem um usuário geral, todos os usuários se autenticam com seu nome de usuário normal e essa senha geral.",
    "Master user" : "Usuário geral",
    "e.g. {example}" : "p. ex., {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Anexado ao nome de usuário. Deve começar com o mesmo separador que {setting} no Dovecot.",
    "Sieve" : "Sieve",
    ...
    "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute" : "* %USERID% e %EMAIL% serão substituídos pelo UID e pelo e-mail do usuário. {ldapPlaceholder} será substituído pelo valor desse atributo LDAP",
