OC.L10N.register(
    ...
    "Easy to use email client which connects to your mail server via IMAP and SMTP." : "Cliente de email fácil de usar que se conecta ao seu servidor de e-mail via IMAP e SMTP.",
    ...
    "Speed up your Mail experience with these quick shortcuts." : "Acelere o uso de seu email com estes atalhos rápidos.",
    ...
    "cc" : "cc",
    "bcc" : "cco",
    "Note that the mail came from a noreply address so your reply will probably not be read." : "Observe que o email veio de um endereço no-reply então sua resposta provavelmente não será lida.",
    "Subject" : "Assunto",
