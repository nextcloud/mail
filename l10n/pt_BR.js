OC.L10N.register(
    ...
    "TextBlock deleted" : "Bloco de texto excluído",
    "Failed to delete textBlock" : "Falha ao excluir o bloco de texto",
    "TextBlock shared with {sharee}" : "Bloco de texto compartilhado com {sharee}",
    "Failed to share textBlock with {sharee}" : "Falha ao compartilhar o bloco de texto com {sharee}",
    "Guest" : "Convidado",
    "Group" : "Grupo",
    "Failed to save textBlock" : "Falha ao salvar o bloco de texto",
    "Shared" : "Compartilhado",
    "Edit {title}" : "Editar {title}",
    "Delete {title}" : "Excluir {title}",
    "Edit text block" : "Editar bloco de texto",
    "Title of the textBlock" : "Título do bloco de texto",
    "Content of the textBlock" : "Conteúdo do bloco de texto",
    ...
    "Insert" : "Colar",
    "Inset text block" : "Inserir bloco de texto",
