...
"Attachment(s) saved to Files." => "Axuntu(os) guardáu(os) a Ficheros.",
"Error while saving attachment(s) to Files." => "Fallu al guardar los axuntos en Ficheros.",
...
"Sending …" => "Unviando...",
"Choose a folder store the attachment" => "Escueyi una carpeta p'almacenar l'axuntu",
"Send" => "Unviar",
