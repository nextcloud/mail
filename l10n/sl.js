OC.L10N.register(
    ...
    "You are trying to send to many recipients in To and/or Cc. Consider using Bcc to hide recipient addresses." : "Poskušaš poslati preveč naslovnikom v Za in Kp poljih. Razmisli o uporabi Skp, da skriješ njihove naslove.",
    ...
    "_Move {number}_::_Move {number}_" : ["Premakni {number} sporočilo","Premakni {number} sporočili","Premakni {number} sporočila","Premakni {number} sporočil"],
    ...
    "_Delete {number}_::_Delete {number}_" : ["Izbriši {number} sporočilo","Izbriši {number} sporočili","Izbriši {number} sporočila","Izbriši {number} sporočil"],
    ...
    "Choose" : "Izbor",
    "Important and unread" : "Pomembno in neprebrano",
    ...
    "Sieve Security" : "Varnost Sieve",
    "Sieve Port" : "Vrata Sieve",
    "Sieve Credentials" : "Poverila Sieve",
    "IMAP Credentials" : "Poverila IMAP",
    "Custom" : "Po meri",
