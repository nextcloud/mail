OC.L10N.register(
    ...
    "Mail server error" : "Mail sunucusu sorunu",
    ...
    "The Mail app can process user data with the help of the configured large language model and provide assistance features like thread summaries, smart replies and event agendas." : "Posta uygulaması, yapılandırılmış geniş dil modelinin yardımıyla kullanıcı verilerini işleyerek konu özetleri, akıllı yanıtlar ve etkinlik gündemleri gibi yardımcı özellikler sağlayabilir.",
    ...
    "The Mail app can classify incoming emails by importance using machine learning. This feature is enabled by default but can be disabled by default here. Individual users will still be able to toggle the feature for their accounts." : "Mail uygulaması, makine öğrenmesini kullanarak gelen e-postaları önem sırasına göre sınıflandırabilir. Bu özellik varsayılan olarak açıktır ancak buradan kapatılabilir. Kullanıcılar kendi hesaplarında bu ayarı değiştirebilir.",
