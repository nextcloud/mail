OC.L10N.register(
    ...
    "The following recipients do not have a PGP key: {recipients}." : "Bu alıcılar PGP anahtarına sahip değiller: {recipients}.",
    ...
    "Encrypt message with Mailvelope" : "Mailvelope ile mesajı şifrele",
    ...
    "Send" : "Gönder",
    "Encrypt and send" : "Şifrele ve gönder",
    ...
    "Mark not spam" : "Spam değil olarak işaretle",
    "Mark as spam" : "Spam olarak işaretle",
    "Delete" : "Sil",
    "Blind copy recipients only" : "Alıcılar gizli kopya olarak eklensin",
    "Show all {nr} messages" : "Tüm {nr} mesajları göster",
    "Collapse messages" : "Mesajları küçült",
    ...
    "Forward" : "İlet",
    "Mark not junk" : "Önemsiz değil olarak işaretle",
    "Mark junk" : "Önemsiz olarak işaretle",
    ...
    "This message is encrypted with PGP. Install Mailvelope to decrypt it." : "Bu mesaj PGP ile şifrelenmiştir. Şifreyi çözmek için Mailvelope yükleyiniz.",
