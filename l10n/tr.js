OC.L10N.register(
    ...
    "Mail server configuration mode" : "E-posta sunucusu yapılandırma kipi",
    "Auto" : "Otomatik",
    "Manual" : "El ile",
    "Name" : "Ad",
    ...
    "Select a mailbox" : "Bir e-posta kutusu seçin",
    "Choose" : "Seçin",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "Yönlendirilen iletiler alıcının sunucusu tarafından reddedilebilir ve şifrelenmiş ise alıcı tarafından okunamaz.",
    "Priority" : "Öncelik",
    ...
    "Using master user and master password" : "Ana kullanıcı ve ana parola kullanılıyor",
    "Using master password for all users" : "Tüm kullanıcılar için ana parola kullanılıyor",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Bir ana kullanıcı olmadan, tüm kullanıcılar normal kullanıcı adları ve bu ana parola ile kimlik doğrulaması yapar.",
    "Master user" : "Ana kullanıcı",
    "e.g. {example}" : "Örnek: {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Kullanıcı adına eklenir. Dovecot {setting} ayarı ile aynı ayraç ile başlamalıdır.",
    "Sieve" : "Sieve",
