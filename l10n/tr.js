OC.L10N.register(
    ...
    "The LDAP aliases integration reads a attribute from the configured LDAP directory to provision email aliases." : "LDAP takma ad bütünleştirmesi e-posta takma adlarını oluşturmak için yapılandırılmış LDAP dizinin bir öznitelik okur.",
    "LDAP attribute for aliases" : "LDAP takma ad özniteliği",
    "A multi value attribute to provision email aliases. For each value an alias is created. Alias existing in Nextcloud which not in the LDAP directory are deleted." : "E-posta takma adları için çok değerli bir öznitelik. Her değer için bir takma ad oluşturulur. Nextcloud üzerinde bulunup LDAP dizininde bulunmayan takma adlar silinir.",
