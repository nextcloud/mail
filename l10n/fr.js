OC.L10N.register(
    ...
    "Step 1: Install Mailvelope browser extension" : "Étape 1 : Installez l'extension de navigateur Mailvelope",
    ...
    "Clear" : "Effacer",
    "Search in folder" : "Recherche dans le dossier",
    ...
    "This summary is AI generated and may contain mistakes." : "Ce résumé est généré par une intelligence artificielle et peut contenir des erreurs.",
    ...
    "Failed to delete text block" : "Échec de suppression du bloc de texte",
    "Text block shared with {sharee}" : "Bloc de texte partagé avec {sharee}",
    "Failed to share text block with {sharee}" : "Échec du partage du bloc de texte avec {sharee}",
    "Share deleted for {name}" : "Partage supprimé pour {name}",
    "Failed to delete share with {name}" : "Échec de la suppression du partage avec {name}",
    "Guest" : "Invité",
    "Group" : "Groupe",
    "Failed to save text block" : "Échec de la sauvegarde du bloc de texte",
    "Shared" : "Partagé",
    ...
    "Install Mailvelope browser extension" : "Installez l'extension de navigateur Mailvelope",
