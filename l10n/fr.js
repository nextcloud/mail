OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!\n\n## Ethical AI Rating\n### Rating: 🟢\n\nPositive:\n* The software for training and inferencing of this model is open source.\n* The model is created and trained on-premises based on the user's own data.\n* The training data is accessible to the user, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "**💌 Une application de courrier électronique pour Nextcloud**\n\n- **🚀 Integration  avec les autres applications !** Contacts, Calendriers, Fichiers et d'autres à venir.\n- **📥 Comptes de messagerie multiples !** Compte pro et perso ? Pas de problème et possibilité d'une boîte de réception unifiée. Connectez n'importe quel compte en IMAP.\n- **🔒 Envoyez et recevez des mails encryptés !** En utilisant la fabuleuse extension du navigateur [Mailvelope](https://mailvelope.com) .\n- **🙈 Nous ne réinventons pas la roue !** Basé sur les excellentes fonctionnalités de [Horde](https://horde.org).\n- **📬 Vous voulez héberger votre propre serveur de messagerie ?** Inutile de vous le proposez puisque vous pouvez installer [Mail-in-a-Box](https://mailinabox.email)!\n\n## Classement éthique IA\n### Classement : 🟢\n\nPositif:\n* Le logiciel pour entraîner et améliorer ce modèle est open source.\n* Le modèle est créé et entraîné sur votre serveur et basé sur les données propres de l'utilisateur.\n* Les données d'entraînement sont accessibles à l'utilisateur, il est possible de vérifier ou corriger les biais et d'optimiser les performances et les émissions de CO2 associées.\n\nEn savoir plus sur le classement éthique IA [sur notre blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    ...
    "The folders to use for drafts, sent messages, deleted messages and archived messages." : "Les dossiers à utiliser pour les brouillons, les messages envoyés, les messages supprimés et les messages archivés.",
    ...
    "Toggle recipients list mode" : "Activer/Désactiver le mode liste des destinataires",
    "Cc" : "Copie à",
    "Bcc" : "Copie cachée à",
    ...
    "When using this setting, a report email will be sent to the SPAM report server when a user clicks \"Mark as spam\"." : "Quand vous utilisez ce paramètre, un e-mail de signalement sera envoyé au serveur de signalement anti-spam quand un utilisateur cliquera sur \"Marquer en tant que spam\". ",
