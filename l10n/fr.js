OC.L10N.register(
    ...
    "Mails" : "E-mails",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following email: %3$s" : "L'email de l'expéditeur %1$s n'est pas dans le carnet d'adresses, mais le nom de l'expéditeur : %2$s est dans le carnet d'adresse avec l'adresse mail suivante : %3$s",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following emails: %3$s" : "L'adresse de l'expéditeur %1$s n'est pas dans le carnet d'adresses, mais le nom de l'expéditeur %2$s est dans le carnet d'adresses avec ces adresses email : %3$s",
    "Sender is using a custom email: %1$s instead of the sender email: %2$s" : "L'expéditeur utilise une adresses personnalisée %1$s au lieu de l'email de l'expéditeur : %2$s",
    ...
    "_Mark {number} unread_::_Mark {number} unread_" : ["Marquer {number} message comme non lu","Marquer {number} messages comme non lus","Marquer {number} messages comme non lus"],
    "_Mark {number} read_::_Mark {number} read_" : ["Marquer {number} message comme lu","Marquer {number} messages comme lus","Marquer {number} messages comme lus"],
    ...
    "_Forward {number} as attachment_::_Forward {number} as attachment_" : ["Transférer {number} message en pièce jointe","Transférer {number} messages en pièce jointe","Transférer {number} messages en pièce jointe"],
    ...
    "Messages sent by you that require a reply but did not receive one after a couple of days will be shown here." : "Les messages que vous avez envoyés demandant une réponse et qui n'en ont reçu aucune après quelques jours seront affichés ici.",
