OC.L10N.register(
    ...
    "Mail server configuration mode" : "Mode de configuration du serveur demessagerie",
    "Auto" : "Auto",
    "Manual" : "Manuel",
    "Name" : "Nom",
    ...
    "Select a mailbox" : "Sélectionner un dossier",
    "Choose" : "Sélectionner",
    ...
    "Contains AI content" : "Contient du contenu IA",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "Les messages redirigés peuvent être rejetés par le serveur qui les reçoit,  et ne peuvent pas être lus par le destinataire s'ils sont chiffrés.",
    "Priority" : "Priorité",
    ...
    "Using master user and master password" : "Utilisation d'un utilisateur maître et d'un mot de passe maître",
    "Using master password for all users" : "Utilisation d'un mot de passe maître pour tous les utilisateurs",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Sans utilisateur maître, tous les utilisateurs s'authentifient avec leur nom d'utilisateur normal et avec ce mot de passe maître.",
    "Master user" : "Utilisateur maître",
    "e.g. {example}" : "ex. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Ajouté au nom d'utilisateur. Doit commencer par le même séparateur que {setting} dans Dovecot.",
    "Sieve" : "Sieve",
    ...
    "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute" : "* %USERID% et %EMAIL% seront remplacés par l'UID de l'utilisateur et par l'e-mail. {ldapPlaceholder} sera remplacé par la valeur de cet attribut LDAP",
