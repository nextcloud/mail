OC.L10N.register(
    ...
    "Select a S/MIME certificate for signing and encrypting" : "Sélectionner un certificat S/MIME pour les signatures et le chiffrage",
    ...
    "Sign message via S/MIME" : "Signer le message via S/MIME",
    ...
    "Only PEM encoded certificates and private keys are supported. PKCS #12 certificates (.p12 files) can't be imported and need to be converted." : "Seulement les clés privés et les certificats encodés en PEM sont supportés. Les certificats PKCS #12 (fichiers .p12) ne peuvent être importés et doivent être convertis.",
    "Back" : "Retour",
    "Submit" : "Soumettre",
    "Certificate imported successfully" : "Certificat importé avec succès",
    "Failed to import the certificate. Please make sure that the private key matches the certificate and is not protected by a passphrase." : "L'import du certificat a échoué. Assurez vous de la correspondance entre la clé privé et le certificat et que celle-ci n'est pas protégée par une phrase de passe.",
