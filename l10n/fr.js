OC.L10N.register(
    ...
    "Welcome to {productName} Mail" : "Bienvenue au Mail{productName} ",
    "Start writing a message by clicking below or select an existing message to display its contents" : "Démarrer l'écriture d'un message en cliquant ci-dessous ou en sélectionnant un message pour afficher son contenu",
