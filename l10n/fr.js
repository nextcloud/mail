OC.L10N.register(
    ...
    "Looking for a way to encrypt your emails?" : "Vous cherchez un moyen de chiffrer vos courriels ?",
    ...
    "Toggle recipients list mode" : "Basculer le mode liste des destinataires",
    "Cc" : "Copie à",
    "Bcc" : "Copie cachée à",
    ...
    "Error saving draft" : "Une erreur est survenue lors de la sauvegarde du brouillon",
    ...
    "Message will be sent at" : "Le message sera envoyé à",
    ...
    "_Mark {number} as important_::_Mark {number} as important_" : ["Marquer {number} importants","Marquer {number} importants","Marquer {number} importants"],
    "_Mark {number} as unimportant_::_Mark {number} as unimportant_" : ["Marquer {number} non-importants","Marquer {number} non-importants","Marquer {number} non-importants"],
    ...
    "_Move {number} thread_::_Move {number} threads_" : ["Déplacer {number} fil de messages","Déplacer {number} fils de messages","Déplacer {number} fils de messages"],
    ...
    "_Delete {number} thread_::_Delete {number} threads_" : ["Supprimer {number} fil de message","Supprimer {number} fils de messages","Supprimer {number} fils de messages"],
    "Report this bug" : "Signaler ce bogue",
    "All day" : "Toute la journée",
    "Create" : "Créer",
    "Event created" : "Événement créé",
    "Could not create event" : "Impossible de créer l'évènement",
    "An event you have been invited to was updated" : "Un événement auquel vous avez été invité a été mis à jour",
    ...
    "Tag name is a hidden system tag" : "Le nom de l'étiquette est une étiquette système cachée",
