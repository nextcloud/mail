OC.L10N.register(
    ...
    "Account created. Please follow the popup instructions to link your Google account" : "Konto utworzone. Postępuj zgodnie z wyskakującymi instrukcjami, aby połączyć swoje konto Google",
    "Loading account" : "Ładowanie konta",
    "Account updated. Please follow the popup instructions to reconnect your Google account" : "Konto zaktualizowane. Postępuj zgodnie z wyskakującymi instrukcjami, aby ponownie połączyć swoje konto Google",
    ...
    "Only PEM encoded certificates and private keys are supported. PKCS #12 certificates (.p12 files) can't be imported and need to be converted." : "Obsługiwane są tylko klucze prywatne oraz certyfikaty zakodowane w PEM. Certyfikatów PKCS #12 (pliki .p12) nie można zaimportować i należy je przekonwertować.",
    "Back" : "Poprzednia",
    "Submit" : "Wyślij",
