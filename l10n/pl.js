OC.L10N.register(
    ...
    "Reply-To email: %1$s  is different from the sender email: %2$s" : "Adres „Odpowiedz do” %1$s różni się od adresu nadawcy: %2$s",
    ...
    "Use internal addresses" : "Używaj adresów wewnętrznych",
    ...
    "Create a new text block" : "Utwórz nowy blok tekstowy",
    "Shared with me" : "Udostępnione dla mnie",
    "Privacy and security" : "Prywatność i bezpieczeństwo",
    ...
    "Internal addresses" : "Adresy wewnętrzne",
    "Highlight external email addresses by enabling this feature, manage your internal addresses and domains to ensure recognized contacts stay unmarked." : "Podświetl zewnętrzne adresy e-mail, włączając tę funkcję. Zarządzaj swoimi wewnętrznymi adresami i domenami, aby upewnić się, że rozpoznane kontakty pozostają nieoznaczone.",
    "S/MIME" : "S/MIME",
    "Manage S/MIME certificates" : "Zarządzaj certyfikatami S/MIME",
    "Mailvelope" : "Mailvelope",
    "Mailvelope is a browser extension that enables easy OpenPGP encryption and decryption for emails." : "Mailvelope to rozszerzenie przeglądarki, które umożliwia łatwe szyfrowanie i deszyfrowanie wiadomości e-mail przy użyciu OpenPGP.",
    "Mailvelope is enabled for the current domain." : "Mailvelope jest włączone dla bieżącej domeny.",
    "Step 1: Install Mailvelope browser extension" : "Krok 1: Zainstaluj rozszerzenie przeglądarki Mailvelope",
    "Step 2: Enable Mailvelope for the current domain" : "Krok 2: Włącz Mailvelope dla bieżącej domeny",
    ...
    "attached" : "załączono",
    "No sent folder configured. Please pick one in the account settings." : "Nie skonfigurowano folderu wysłanych. Wybierz go w ustawieniach konta.",
    ...
    "Flag" : "Flaga",
    "The stop action ends all processing" : "Akcja zatrzymania kończy całe przetwarzanie",
    "Operator" : "Operator",
    "Delete test" : "Usuń test",
    "Update mail filter" : "Zaktualizuj filtr poczty",
    "Filter name" : "Nazwa filtra",
    "If all the conditions are met" : "Jeśli wszystkie warunki są spełnione",
    "If any of the conditions are met" : "Jeśli którykolwiek z warunków jest spełniony",
    "Tests are applied to incoming emails on your mail server, targeting fields such as subject (the email's subject line), from (the sender), and to (the recipient). You can use the following operators to define conditions for these fields:" : "Testy są stosowane do przychodzących wiadomości e-mail na twoim serwerze pocztowym, obejmując pola takie jak temat (wiadomości), od (nadawcy) i do (odbiorcy). Możesz używać następujących operatorów do definiowania warunków dla tych pól:",
    "An exact match. The field must be identical to the provided value." : "Dokładne dopasowanie. Pole musi być identyczne z podaną wartością.",
    "Then perform these actions" : "Następnie wykonaj te działania",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "Działania są uruchamiane, gdy podane testy są prawdziwe. Dostępne są następujące działania:",
    "Moves the message into a specified folder." : "Przenieś wiadomość do określonego folderu.",
    "Adds a flag to the message." : "Dodaj flagę do wiadomości.",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "Zatrzymaj wykonywanie skryptu filtra. Żadne dalsze filtry nie będą przetwarzane po tym działaniu.",
