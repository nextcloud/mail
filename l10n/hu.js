OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](http://horde.org) libraries.\n- **📬 Want to host your own mail server?** We don’t have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!" : "** 💌 Levelező alkalmazás a Nextcloudhoz **\n- ** 🚀 Integráció más Nextcloud-alkalmazásokkal! ** Jelenleg a Névjegyek, a Naptár és a Fájlok - de jönnek még egyebek is\n- ** 📥 Több e-mail fiók! ** Személyes és vállalati fiók? Nem probléma, és még van egy szép egységes postaládája. Csatlakoztasson bármilyen IMAP-fiókot.\n- ** 🔒 Titkosított levelek küldése és fogadása** a nagyszerű [Mailvelope](https://mailvelope.com) böngészőbővítmény használatával.\n- ** 🙈 Nem találjuk fel a kereket újra! ** A nagyszerű [Horde](http://horde.org) könyvtárak felhasználásával.\n- ** 📬 Saját mail szerverét akarja üzemeltetni? ** Ezt sem kell újból lefejleszteni, mivel beállíthatja [Mail-in-a-Box](https://mailinabox.email)-ot !",
