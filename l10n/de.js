OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://www.horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!\n\n## Ethical AI Rating\n\n### Priority Inbox\n\nPositive:\n* The software for training and inferencing of this model is open source.\n* The model is created and trained on-premises based on the user's own data.\n* The training data is accessible to the user, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Thread Summaries (opt-in)\n\n**Rating:** 🟢/🟡/🟠/🔴\n\nThe rating depends on the installed text processing backend. See [the rating overview](https://docs.nextcloud.com/server/latest/admin_manual/ai/index.html) for details.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "**💌 Eine E-Mail-App für Nextcloud**- **🚀 Integration in andere Nextcloud-Apps!** Derzeit Kontakte, Kalender und Dateien – weitere folgen.- **📥 Mehrere E-Mail-Konten!** Privat- und Firmenkonto? Kein Problem mit einem schönen einheitlichen Posteingang. Verbinden Sie ein beliebiges IMAP-Konto.- **🔒 Senden und empfange verschlüsselte E-Mails!** Mit der großartigen Browsererweiterung [Mailvelope](https://mailvelope.com).- **🙈 Wir erfinden das Rad nicht neu!** Basierend auf den großartigen [Horde](https://www.horde.org)-Bibliotheken.- **📬 Möchten du Ideinen eigenen Mailserver hosten?** Wir müssen dies nicht erneut implementieren, da du [Mail-in-a-Box](https://mailinabox.email) verwenden kannst!## Ethische KI-Bewertung### PrioritätsposteingangPositiv:* Die Software zum Trainieren und Inferenzieren dieses Modells ist Open Source.* Das Modell wird vor Ort basierend auf den eigenen Daten des Benutzers erstellt und trainiert.* Die Trainingsdaten sind für den Benutzer zugänglich und ermöglichen so die Überprüfung oder Korrektur von Verzerrungen oder die Optimierung der Leistung und des CO2-Verbrauchs.### Zusammenfassungen von Unterhaltungen (Opt-in)**Bewertung:** 🟢/🟡/🟠/🔴Die Bewertung hängt vom installierten Textverarbeitungs-Backend ab. Einzelheiten finden sich in [der Bewertungsübersicht](https://docs.nextcloud.com/server/latest/admin_manual/ai/index.html).Erfahre mehr über das Nextcloud Ethical AI Rating [in unserem Blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
