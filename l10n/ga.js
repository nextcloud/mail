OC.L10N.register(
    ...
    "TextBlock deleted" : "Scriosadh an BlocTéacs",
    "Failed to delete textBlock" : "Theip ar scriosadh an bhloc téacs",
    "TextBlock shared with {sharee}" : "BlocTéacs roinnte le {sharee}",
    "Failed to share textBlock with {sharee}" : "Theip ar textBlock a roinnt le {sharee}",
    ...
    "Guest" : "Aoi",
    "Group" : "Grúpa",
    "Failed to save textBlock" : "Theip ar shábháil an bhloc téacs",
    "Shared" : "Roinnte",
    "Edit {title}" : "Cuir in Eagar {title}",
    "Delete {title}" : "Scrios {title}",
    "Edit text block" : "Cuir bloc téacs in eagar",
    "Title of the textBlock" : "Teideal an bhloic téacs",
    "Content of the textBlock" : "Ábhar an bhloic téacs",
    "Shares" : "Scaireanna",
