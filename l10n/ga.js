OC.L10N.register(
    ...
    "Mail server configuration mode" : "Modh cumraíochta an fhreastalaí ríomhphoist",
    "Auto" : "Uath",
    "Manual" : "Lámhleabhar",
    "Name" : "Ainm",
    ...
    "Select a mailbox" : "Roghnaigh bosca poist",
    "Choose" : "Roghnaigh",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "D’fhéadfadh an freastalaí glactha diúltú do theachtaireachtaí atá atreoraithe, agus ní féidir leis an bhfaighteoir iad a léamh má tá siad criptithe.",
    "Priority" : "Tosaíocht",
    ...
    "Using master user and master password" : "Ag baint úsáide as príomhúsáideoir agus príomhfhocal faire",
    "Using master password for all users" : "Ag baint úsáide as príomhfhocal faire do gach úsáideoir",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Gan máistirúsáideoir, déanann gach úsáideoir fíordheimhniú lena ngnáthainm úsáideora agus an máistirphasfhocal seo.",
    "Master user" : "Príomhúsáideoir",
    "e.g. {example}" : "m.sh. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Cuireadh leis an ainm úsáideora é. Ní mór tosú leis an deighilteoir céanna le {setting} i Dovecot.",
    "Sieve" : "Criathar",
