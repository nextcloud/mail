OC.L10N.register(
    ...
    "_Move {number}_::_Move {number}_" : ["Verplaatsen {number}","Verplaatsen {number}"],
    ...
    "_Delete {number}_::_Delete {number}_" : ["Verwijderen {number}","Verwijderen {number}"],
    ...
    "Successfully provisioned {count} accounts." : "{count} accounts succevol ingericht.",
