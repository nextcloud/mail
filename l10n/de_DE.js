OC.L10N.register(
    ...
    "Please select languages to translate to and from" : "Bitte die Sprachen aus wählen, in die bzw. aus denen übersetzt werden soll",
    ...
    "Sender" : "Absender",
    "Recipient" : "Empfänger",
    "Create a new mail filter" : "Neuen E-Mailfilter erstellen",
    "Choose the headers you want to use to create your filter. In the next step, you will be able to refine the filter conditions and specify the actions to be taken on messages that match your criteria." : "Wählen Sie die Header aus, mit denen Sie Ihren Filter erstellen möchten. Im nächsten Schritt können dann die Filterbedingungen verfeinert und die Aktionen festgelegt werden, die auf Nachrichten angewandt werden sollen, auf die die Ihren Kriterien zutreffen.",
