OC.L10N.register(
    ...
    "You are trying to send to many recipients in To and/or Cc. Consider using Bcc to hide recipient addresses." : "Sie versuchen, an viele Empfänger in To und/oder Cc zu senden. Erwägen Sie die Verwendung von Bcc, um Empfängeradressen zu  verbergen",
    ...
    "The account for {email} and cached email data will be removed from Nextcloud, but not from your email provider." : "Das Konto für {E-Mail} und zwischengespeicherte E-Mail-Daten werden aus Nextcloud entfernt, jedoch nicht von Ihrem E-Mail-Provider.",
    ...
    "Unexpected error during account creation" : "Unerwarteter Fehler bei der Erstellung des Kontos",
