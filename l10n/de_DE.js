OC.L10N.register(
    ...
    "Mail server configuration mode" : "Mailserver-Einrichtungsmodus",
    "Auto" : "Automatisch",
    "Manual" : "Manuell",
    "Name" : "Name",
    ...
    "Select a mailbox" : "Ein Postfach auswählen",
    "Choose" : "Auswählen",
    ...
    "Start writing a message by clicking below or select an existing message to display its contents" : "Unten klicken, um mit dem Erstellen einer Nachricht zu beginnen, oder eine vorhandene Nachricht auswählen, um deren Inhalt anzuzeigen",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "Weitergeleitete Nachrichten können vom empfangenden Server abgelehnt werden und sind, falls verschlüsselt, für den Empfänger nicht lesbar.",
    "Priority" : "Priorität",
    ...
    "Using master user and master password" : "Verwende Master-Benutzer und Master-Passwort",
    "Using master password for all users" : "Verwende Master-Passwort für alle Benutzer",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Ohne einen Master-Benutzer melden sich alle Benutzer mit ihrem normalen Benutzernamen und diesem Master-Passwort.",
    "Master user" : "Master-Benutzer",
    "e.g. {example}" : "Z. B. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "An den Benutzernamen angehängt. Muss mit demselben Trennzeichen wie {setting} in Dovecot beginnen.",
    "Sieve" : "Sieve",
