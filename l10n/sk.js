OC.L10N.register(
    ...
    "{account_email} has been delegated to you" : "{account_email} vám delegoval prístup",
    "{user} delegated {account} to you" : "{user} vám delegoval účet {account}",
    "{account_email} is no longer delegated to you" : "{account_email} už vám nie je delegovaný",
    "{user} revoked delegation for {account}" : "{user} zrušil delegovanie účtu {account}",
    ...
    "Mail server configuration mode" : "Režim konfigurácie poštového servera",
    "Auto" : "Automaticky",
    ...
    "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead." : "Google vyžaduje overenie prostredníctvom OAuth. Ak váš správca Nextcloudu nenakonfiguroval Google OAuth, môžete namiesto toho použiť heslo aplikácie Google.",
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Microsoft vyžaduje overenie prostredníctvom OAuth. Požiadajte správcu Nextcloudu, aby v nastaveniach správcu nakonfiguroval Microsoft OAuth.",
    ...
    "{email} (delegated)" : "{email} (delegované)",
    ...
    "Mark messages as read" : "Označiť správy ako prečítané",
    ...
    "_After %n second_::_After %n seconds_" : ["Po %n sekunde","Po %n sekundách","Po %n sekundách","Po %n sekundách"],
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "Správy bez príjemcov v poli „Komu“ môžu niektorí poskytovatelia pošty odmietnuť.",
    "Cc" : "Kópia",
    "Bcc" : "Skrytá kópia",
    "Subject" : "Predmet",
    "Subject …" : "Predmet …",
    ...
    "Mark as AI generated" : "Označiť ako vygenerované umelou inteligenciou",
    ...
    "Remove attachment {fileName}" : "Odstrániť prílohu {fileName}",
    "Choose a file" : "Vyberte súbor",
    "Add as attachment" : "Pridať ako prílohu",
    "Add as share link" : "Pridať ako odkaz na zdieľanie",
    ...
    "_{count} attachment_::_{count} attachments_" : ["{count} príloha","{count} prílohy","{count} príloh","{count} príloh"],
    "Untitled message" : "Nepomenovaná správa",
    "Expand composer" : "Zobraziť editor správ",
    "Close composer" : "Zatvoriť editor správ",
    "Confirm" : "Potvrdiť",
    "Delegate access" : "Delegovať prístup",
    "Revoke" : "Odvolať",
    "{userId} will no longer be able to act on your behalf" : "{userId} už nebude môcť konať vo vašom mene",
    "Could not fetch delegates" : "Nepodarilo sa načítať delegované účty",
    "Delegated access to {displayName}" : "Delegovaný prístup k účtu {displayName}",
    "Could not delegate access" : "Nepodarilo sa delegovať prístup",
    "Revoked access for {displayName}" : "Prístup pre {displayName} bol zrušený",
    "Could not revoke delegation" : "Nepodarilo sa zrušiť delegovanie",
    "Delegation" : "Delegovanie",
    "Allow users to send, receive, and delete mail on your behalf" : "Povoliť používateľom odosielať, prijímať a mazať poštu vo vašom mene",
    "Revoke access" : "Odvolať prístup",
    "Add delegate" : "Pridať delegáta",
    "Select a user" : "Vyberte používateľa",
    "They will be able to send, receive, and delete mail on your behalf" : "Budú môcť odosielať, prijímať a mazať poštu vo vašom mene",
    "Revoke access?" : "Odvolať prístup?",
    ...
    "Choose a folder to store the message in" : "Vyberte priečinok, do ktorého chcete správu uložiť",
    "Message saved to Files" : "Správa uložená do Súborov",
    "Message could not be saved" : "Správu sa nepodarilo uložiť",
    "This summary was AI-generated" : "Toto zhrnutie vygenerovala umelá inteligencia",
    ...
    "Save message to Files" : "Uložiť správu do Súborov",
    ...
    "_Move {number} thread_::_Move {number} threads_" : ["Presunúť {number} vlákno","Presunúť {number} vlákna","Presunúť {number} vlákien","Presunúť {number} vlákien"],
    ...
    "This description was generated by AI." : "Tento opis vygenerovala umelá inteligencia.",
    ...
    "Select a mailbox" : "Vyberte schránku",
    "Choose" : "Vybrať",
    ...
    "Could not generate direct link: Message ID is missing" : "Nepodarilo sa vygenerovať priamy odkaz: Chýba ID správy",
    "Direct link copied to clipboard" : "Priamy odkaz bol skopírovný do schránky",
    "Copy direct link" : "Kopírovať priamy odkaz",
    "Forward" : "Preposlať",
    ...
    "could not delete account" : "nepodarilo sa odstrániť účet",
    ...
    "Delegate account" : "Delegovať účet",
    ...
    "Restore composer" : "Obnoviť editor",
    "Maximize composer" : "Maximalizovať editor",
    "Minimize composer" : "Minimalizovať editor",
    "Close contact info" : "Zavrieť informácie o kontakte",
    ...
    "Signature …" : "Podpis …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Tento podpis je väčší ako 2 MB, zvyčajne preto, že obsahuje vložený obrázok. Pridáva sa do každej odoslanej správy a môže spomaľovať editor.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Tento podpis obsahuje obrázky. Nové správy budú používať formátovaný text, aj keď máte režim písania nastavený na čistý text.",
    ...
    "Contains AI content" : "Obsahuje obsah vytvorený umelou inteligenciou",
    ...
    "This summary is AI-generated and may contain mistakes." : "Toto zhrnutie vygenerovala umelá inteligencia a môže obsahovať chyby.",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "Presmerované správy môžu byť odmietnuté prijímajúcim serverom a v prípade zašifrovania ich príjemca nemôže prečítať.",
    "Priority" : "Priorita",
    ...
    "Using master user and master password" : "Používa sa hlavný používateľ a hlavné heslo",
    "Using master password for all users" : "Používa sa hlavné heslo pre všetkých používateľov",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Bez hlavného používateľa sa všetci používatelia overujú svojím bežným používateľským menom a týmto hlavným heslom.",
    "Master user" : "Hlavný používateľ",
    "e.g. {example}" : "napr. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Pripojí sa k používateľskému menu. Musí začínať rovnakým oddeľovačom ako {setting} v Dovecote.",
    "Sieve" : "Sieve",
    ...
    "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute" : "* %USERID% a %EMAIL% sa nahradia UID používateľa a jeho e-mailom. {ldapPlaceholder} sa nahradí hodnotou tohto atribútu LDAP",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Textové bloky sú opakovane použiteľné časti textu, ktoré možno vložiť do správ. V paneli Nastavenia si môžete vytvoriť vlastné bloky.",
    ...
    "Insert image from Files" : "Vložiť obrázok zo Súborov",
    "Choose an image" : "Vyberte obrázok",
    "Select an image" : "Vybrať obrázok",
    "Insert {name}" : "Vložiť {name}",
    "The selected image is too large to embed" : "Vybraný obrázok je príliš veľký na vloženie",
    "Could not insert the selected image" : "Vybraný obrázok sa nepodarilo vložiť",
    "All" : "Všetko",
    "Drafts" : "Koncepty",
    ...
    "Date:" : "Dátum:",
    "Printing from the browser menu is not supported" : "Tlač z ponuky prehliadača nie je podporovaná",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "Ak chcete vytlačiť tento e-mail, stlačte {shortcut} alebo v ponuke správy použite akciu „Tlačiť správu“.",
