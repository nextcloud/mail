OC.L10N.register(
    ...
    "TextBlock deleted" : "已刪除文字區塊",
    "Failed to delete textBlock" : "無法刪除文字區塊",
    "TextBlock shared with {sharee}" : "已與 {sharee} 分享文字區塊",
    "Failed to share textBlock with {sharee}" : "與 {sharee} 分享文字區塊失敗",
    "Share deleted for {name}" : "{name} 的分享已被刪除",
    "Failed to delete share with {name}" : "無法刪除與 {name} 的分享",
    "Guest" : "訪客",
    "Group" : "群組",
    "Failed to save textBlock" : "儲存文字區塊失敗",
    "Shared" : "已分享",
    "Edit {title}" : "編輯 {title}",
    "Delete {title}" : "刪除 {title}",
    "Edit text block" : "編輯文字區塊",
    "Title of the textBlock" : "文字區塊的標題",
    "Content of the textBlock" : "文字區塊內容",
    "Shares" : "分享",
    "Search for users or groups" : "搜尋使用者或群組",
    "Choose a text block to insert at the cursor" : "選擇文字區塊以在游標處插入",
    "Insert" : "插入",
    "Inset text block" : "插入文字區塊",
