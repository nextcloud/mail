OC.L10N.register(
    ...
    "Sign message via S/MIME" : "透過 S/MIME 簽署訊息",
    ...
    "Certificate" : "憑證",
    "Private key" : "私鑰",
    "Only PEM encoded certificates and private keys are supported. PKCS #12 certificates (.p12 files) can't be imported and need to be converted." : "僅支援 PEM 編碼憑證與私鑰。無法匯入 PKCS #12 憑證（.p12 檔案），必須轉換。",
    "Back" : "返回",
    "Submit" : "遞交",
