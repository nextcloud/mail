OC.L10N.register(
    ...
    "There can only be one configuartion per domain, and only one wildcard domain configuration." : "每個網域只能有一個設定，且僅能有一個萬用字元網域設定。",
    "These settings can be used in conjuction with each other." : "這些設定可以相互結合使用。",
    ...
    "Successfully provisioned {count} accounts." : "已成功設定 {count} 個帳號。",
    "There was an error when provisioning accounts." : "設定帳號時發生錯誤。",
    "Sucessfully deleted and deprovisioned accounts for \"{domain}\"" : "成功刪除並取消設定了「{domain}」的帳號",
