OC.L10N.register(
    ...
    "The LDAP aliases integration reads a attribute from the configured LDAP directory to provision email aliases." : "LDAP 別名整合會從設定好的 LDAP 目錄讀取屬性以提供電子郵件別名。",
    "LDAP attribute for aliases" : "別名的 LDAP 屬性",
    "A multi value attribute to provision email aliases. For each value an alias is created. Alias existing in Nextcloud which not in the LDAP directory are deleted." : "用於設定電子郵件別名的多重值屬性。為每個值建立一個別名。刪除存在於 Nextcloud 但不在 LDAP 目錄中的別名。",
    "Save Config" : "儲存設定",
