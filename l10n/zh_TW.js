OC.L10N.register(
    ...
    "Messages that your mark as favorite will be shown at the top of folders. You can disable this behavior in the app settings" : "您標記為最愛的訊息將顯示於資料夾頂端。您可在應用程式設定中停用此功能。",
