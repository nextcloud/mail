OC.L10N.register(
    ...
    "TextBlock deleted" : "TextBlock deleted",
    "Failed to delete textBlock" : "Failed to delete textBlock",
    "TextBlock shared with {sharee}" : "TextBlock shared with {sharee}",
    "Failed to share textBlock with {sharee}" : "Failed to share textBlock with {sharee}",
    "Share deleted for {name}" : "Share deleted for {name}",
    "Failed to delete share with {name}" : "Failed to delete share with {name}",
    "Guest" : "Guest",
    "Group" : "Group",
    "Failed to save textBlock" : "Failed to save textBlock",
    "Shared" : "Shared",
    "Edit {title}" : "Edit {title}",
    "Delete {title}" : "Delete {title}",
    "Edit text block" : "Edit text block",
    "Title of the textBlock" : "Title of the textBlock",
    "Content of the textBlock" : "Content of the textBlock",
    "Shares" : "Shares",
