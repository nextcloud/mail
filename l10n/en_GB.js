OC.L10N.register(
    ...
    "Mail server configuration mode" : "Mail server configuration mode",
    "Auto" : "Auto",
    "Manual" : "Manual",
    "Name" : "Name",
    ...
    "Mark as AI generated" : "Mark as AI generated",
    ...
    "Contains AI content" : "Contains AI content",
    ...
    "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted." : "Redirected messages might be rejected by the receiving server, and cannot be read by the recipient if encrypted.",
    "Priority" : "Priority",
    ...
    "Using master user and master password" : "Using master user and master password",
    "Using master password for all users" : "Using master password for all users",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Without a master user, all users authenticate with their normal username and this master password.",
    "Master user" : "Master user",
    "e.g. {example}" : "e.g. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Appended to the username. Must start with the same separator as {setting} in Dovecot.",
    "Sieve" : "Sieve",
    ...
    "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute" : "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute",
