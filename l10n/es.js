OC.L10N.register(
    ...
    "Account created. Please follow the popup instructions to link your Google account" : "La cuenta ha sido creada. Por favor siga las instrucciones emergentes para enlazar su cuenta Google",
    "Loading account" : "Cargando cuenta",
    "Account updated. Please follow the popup instructions to reconnect your Google account" : "La cuenta ha sido actualizada. Por favor siga las instrucciones emergentes para reconectar su cuenta Google",
    ...
    "The folders to use for drafts, sent messages, deleted messages and archived messages." : "Carpetas usadas para los borradores, mensajes enviados, mensajes eliminados y mensajes archivados.",
    ...
    "Sign message via S/MIME" : "Firmar mensaje con S/MIME",
    ...
    "Search in mailbox" : "Buscar en bandeja",
    ...
    "Select sender" : "Seleccionar remitente",
    "Select recipient" : "Seleccionar recipiente",
    "Select cc recipient" : "Seleccionar recipiente cc",
    "Select bcc recipient" : "Seleccionar recipiente bcc",
    "Tags" : "Etiquetas",
    ...
    "You have to register a new Client ID for a \"Web application\" in the Google Cloud console. Add the URL {url} as authorized redirect URI." : "Debe registrar un nuevo ID de clietne para una \"aplicación web\" en la consola Google Cloud. Agregue el URL {url} como un URI de redirección autorizado.",
    ...
    "Only PEM encoded certificates and private keys are supported. PKCS #12 certificates (.p12 files) can't be imported and need to be converted." : "Solo se admiten certificados codificados con PEM y claves privadas. Los certificados PKCS #12 (archivos .p12) no se pueden importar y deben convertirse.",
    "Back" : "Atrás",
    "Submit" : "Enviar",
