OC.L10N.register(
    ...
    "Flag" : "Indicador",
    "The stop action ends all processing" : "La acción de detener finaliza todo el procesamiento",
    "Sender" : "Remitente",
    ...
    "If all the conditions are met" : "Si todas las condiciones se cumplen",
    "If any of the conditions are met" : "Si cualquiera de las condiciones se cumple",
    "Tests are applied to incoming emails on your mail server, targeting fields such as subject (the email's subject line), from (the sender), and to (the recipient). You can use the following operators to define conditions for these fields:" : "Las pruebas se aplican a los correos entrantes en su servidor de correo, con condiciones aplicadas a distintos campos como asunto (el asunto del correo), de (el remitente), y a (el destinatario). Puede utilizar los siguientes operadores para estos campos:",
    "An exact match. The field must be identical to the provided value." : "Una coincidencia exacta. El campo debe ser idéntico al valor indicado.",
    ...
    "Then perform these actions" : "Entonces, llevar a cabo estas acciones",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "Las acciones son desencadenadas cuando las pruebas anteriores se cumplan. Las siguientes acciones están disponibles:",
    "Moves the message into a specified folder." : "Mueve el mensaje a una carpeta especificada.",
    "Adds a flag to the message." : "Añade un indicador al mensaje.",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "Detiene la ejecución del script de filtrado. No se procesarán más filtros tras esta acción.",
    ...
    "Copy to Sent Mailbox" : "Copiar a la bandeja Enviados",
    "Search in mailbox" : "Buscar en el buzón",
