OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!\n\n## Ethical AI Rating\n### Rating: 🟢\n\nPositive:\n* The software for training and inferencing of this model is open source.\n* The model is created and trained on-premises based on the user's own data.\n* The training data is accessible to the user, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "**💌 Nextcloud 邮件应用**\n\n- **🚀 一次与其他Nextcloud应用的融合！** 现有联系人，日历和文件 - 更多内容，敬请期待。\n- **📥 多个邮件帐户！** 使用个人和公司帐户？没问题，还有精美的整合收件箱。连接任意IMAP帐户。\n- **🔒 发送&接收加密邮件！** 使用优秀的 [Mailvelope] (https://mailvelope.com) 浏览器扩展。 \n- **🙈 我们可不是在重造轮子！** 基于优秀的 [Horde] (https://horde.org) 库。\n- **📬 想管理自己的邮件服务器？** 我们不必重做，因为你可以搭建 [Mail-in-a-Box](https://mailinabox.email)！\n\n## 道德AI评级\n### 评级: 🟢\n\n优点:\n* 此模型中用于训练和推论的软件是开源的。\n* 该模型基于用户自己的数据即时创建、训练。\n* 训练数据对用户开放，使得检查、纠正偏见或优化性能和CO2使用成为可能。\n\n[在我们的博客中](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)了解更多有关Nextcloud道德AI评级的信息。",
    ...
    "Automatically classify importance of new email" : "按照重要性自动分类新邮件",
    ...
    "Sign or Encrypt with S/MIME was selected, but we don't have a certificate for the selected alias. The message will not be signed or encrypted." : "已选择使用S/MIME签名或加密，但选中的别名没有证书。此消息将不会被签名或加密。",
    ...
    "Sent" : "已发送",
    "Trash" : "废件箱",
    "Connect OAUTH2 account" : "连接 OAUTH2 账户",
