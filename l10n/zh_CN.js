OC.L10N.register(
    ...
    "_Move {number}_::_Move {number}_" : ["移动 {number} 封"],
    "_Forward {number} as attachment_::_Forward {number} as attachment_" : ["转发 {number} 封为附件"],
    "_Delete {number}_::_Delete {number}_" : ["删除 {number} 封"],
    ...
    "There can only be one configuartion per domain, and only one wildcard domain configuration." : "每个域只能有一个配置，并且只有一个通配符域配置。",
    "These settings can be used in conjuction with each other." : "这些设置可以相互结合使用。 ",
    ...
    "Successfully provisioned {count} accounts." : "成功开通了 {count} 个账户",
    "There was an error when provisioning accounts." : "开通账户时发生一个错误",
    "Sucessfully deleted and deprovisioned accounts for \"{domain}\"" : "成功删除和没收了  \"{domain}\" 账户",
