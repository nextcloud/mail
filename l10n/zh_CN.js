OC.L10N.register(
    ...
    "Defaults" : "默认",
    "Here you can select where Nextcloud Mail stores your drafts as well as sent and deleted messages." : "在这里，您可以选择 Nextcloud 邮件保存您的草稿以及已发送和删除的邮件的位置。",
    "Draft messages are saved to:" : "草稿邮件保存在：",
    "Sent messages are saved to:" : "已发送邮件保存在：",
    "Deleted messages are moved to:" : "已删除邮件将被移至：",
    "Auto" : "自动",
    "Name" : "姓名",
    "Mail Address" : "邮箱",
    "Password" : "密码",
    ...
    "Mark {number} unread" : "将 {number} 标记为未读",
    "Mark {number} read" : "将 {number} 标记为已读",
    "Unfavorite {number}" : "取消收藏 {number}",
