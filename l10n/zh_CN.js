OC.L10N.register(
    ...
    "Messages that your mark as favorite will be shown at the top of folders. You can disable this behavior in the app settings" : "您标记为收藏的邮件将显示在文件夹顶部。您可以在应用设置中禁用",
