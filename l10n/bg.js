OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!" : "**💌 Приложение за поща за Nextcloud**\n\n- **🚀 Интеграция с други приложения на Nextcloud!** В момента Контакти, Календар и Файлове – предстои още.\n- **📥 Множество пощенски профили!** Личен и фирмен профил? Няма проблем и хубава унифицирана входяща кутия. Свържете всеки IMAP профил.\n- **🔒 Изпращайте и получавате криптирани имейли!** Използвайки страхотното разширение за браузър [Mailvelope](https://mailvelope.com).\n- **🙈Ние не преоткриваме колелото!** Въз основа на страхотните библиотеки [Horde](https://horde.org).\n- **📬 Искате да хоствате свой собствен сървър за електронна поща?** Не е нужно да допълваме отново, тъй като бихте могли да настроите [Поща - в - кутия] (https://mailinabox.email)!",
    ...
    "Sign message via S/MIME" : "Подписване на съобщение чрез S/MIME",
    ...
    "_Delete {number} thread_::_Delete {number} threads_" : ["Изтриване на {number} нишки","Изтриване на {number} нишки"],
    ...
    "Sieve Security" : "Сигурност на Сито",
    "Sieve Port" : "Порт на Сито",
    "Sieve Credentials" : "Удостоверяване/идентификационни данни/ на Сито",
    "IMAP Credentials" : "IMAP Идентификационни данни",
    ...
    "Only PEM encoded certificates and private keys are supported. PKCS #12 certificates (.p12 files) can't be imported and need to be converted." : "Поддържат се само PEM кодирани сертификати и частни ключове. Сертификатите PKCS #12 (.p12 файлове) не могат да бъдат импортирани и трябва да бъдат конвертирани.",
    "Back" : "Назад",
    "Submit" : "Изпращане",
