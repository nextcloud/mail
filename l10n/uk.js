OC.L10N.register(
    ...
    "_Unfavorite {number}_::_Unfavorite {number}_" : ["Без зірки {number}","Без зірки {number}","Без зірки {number}","Без зірки {number}"],
    "_Favorite {number}_::_Favorite {number}_" : ["Із зіркою {number}","Із зіркою {number}","Із зіркою {number}","Із зіркою {number}"],
