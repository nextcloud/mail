OC.L10N.register(
    ...
    "Flag" : "Прапор",
    "The stop action ends all processing" : "Дія зупинки завершує всю обробку",
    "Sender" : "Передавач",
    "Recipient" : "Одержувач",
    ...
    "contains" : "містить",
    "matches" : "містить",
    "Delete test" : "Тест на видалення",
    "Update mail filter" : "Оновлення поштового фільтра",
    "Filter name" : "Назва фільтра",
    "If all the conditions are met" : "Якщо всі умови дотримані",
    "If any of the conditions are met" : "Якщо виконується будь-яка з умов",
    "Tests are applied to incoming emails on your mail server, targeting fields such as subject (the email's subject line), from (the sender), and to (the recipient). You can use the following operators to define conditions for these fields:" : "Тести застосовуються до вхідних листів на вашому поштовому сервері, перевіряючи такі поля, як тема (заголовок листа), від (відправник) і кому (одержувач). Ви можете використовувати наступні оператори, щоб визначити умови для цих полів:",
    "An exact match. The field must be identical to the provided value." : "Точний збіг. Поле має бути ідентичним наданому значенню.",
    ...
    "Then perform these actions" : "Потім виконайте такі дії",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "Дії запускаються, коли вказані тести є істинними. Доступні наступні дії:",
    "Moves the message into a specified folder." : "Переміщує повідомлення до вказаної папки.",
    "Adds a flag to the message." : "Додає прапорець до повідомлення.",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "Зупиняє виконання скрипта фільтра. Після цієї дії подальші фільтри не будуть оброблятися.",
    ...
    "TextBlock deleted" : "ТекстBlock видалено",
    "Failed to delete textBlock" : "Не вдалося видалити textBlock",
    "TextBlock shared with {sharee}" : "TextBlock, спільний з {sharee}",
    "Failed to share textBlock with {sharee}" : "Не вдалося поділитися textBlock з {sharee}",
    ...
    "Guest" : "Гість",
    "Group" : "Група",
    "Failed to save textBlock" : "Не вдалося зберегти textBlock",
    "Shared" : "Спільне",
    "Edit {title}" : "Редагувати {title}",
    "Delete {title}" : "Вилучити {title}",
    "Edit text block" : "Редагувати текстовий блок",
    "Title of the textBlock" : "Назва текстового блоку",
    "Content of the textBlock" : "Вміст текстового блоку",
    "Shares" : "Спільне",
    ...
    "Repair mailbox" : "Відновлення поштової скриньки",
    ...
    "If all tests pass, then the actions will be executed" : "Якщо всі тести пройдені, то дії будуть виконані",
    "If one test pass, then the actions will be executed" : "Якщо один тест пройдено, то дії будуть виконані",
    "Tests" : "Тести",
    "New test" : "Новий тест",
    "Actions" : "Дії",
    "New action" : "Нова дія",
    "Message copied to \"Sent\" mailbox" : "Повідомлення скопійовано до поштової скриньки \"Відправлені\"",
    "Could not copy message to \"Sent\" mailbox" : "Не вдалося скопіювати повідомлення до поштової скриньки \"Надіслані\""
},
