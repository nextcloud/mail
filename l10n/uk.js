OC.L10N.register(
    ...
    "Activate body search" : "Увімкнути пошук у тілі листа",
    ...
    "Auto tagging text" : "Автоматичні мітки для тексту",
    ...
    "Automatically classify importance of new email" : "Автоматично визначати важливість нових листів",
    ...
    "Toggle recipients list mode" : "Перемкнути режим показу отримувачів",
    "Cc" : "Копія",
    "Bcc" : "Всс",
    ...
    "Add share link from {productName} Files" : "Додати посилання на спільний ресурс {productName} з Файлів",
    ...
    "_Delete {number} thread_::_Delete {number} threads_" : ["Вилучити {number} ланцюжок","Вилучити {number} ланцюжки","Вилучити {number} ланцюжків","Вилучити {number} ланцюжків"],
    ...
    "Sieve Security" : "Безпека Sieve",
    "Sieve Port" : "Порт Sieve",
    "Sieve Credentials" : "Облікові дані Sieve",
    ...
    "Thread Summary" : "Підсумок ланцюжка",
