OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!" : "**💌 Поштова програма для Nextcloud** \n\n- **🚀 Інтеграція з іншими програмами Nextcloud!** Наразі контакти, календар і файли – більше буде. \n- **📥 Кілька облікових записів електронної пошти!** Особистий або корпоративний обліковий запис? Жодних проблем, зручний універсальний каталог \"Вхідні\". Підключіть будь-який обліковий запис IMAP. \n- **🔒 Надсилайте та отримуйте зашифровані листи!** Використовуючи чудове розширення для браузера [Mailvelope](https://mailvelope.com). \n- **🙈 Ми не винаходимо велосипед!** На основі чудових бібліотек [Horde](https://horde.org). \n- **📬 Хочете розмістити власний поштовий сервер?** Нам не потрібно реалізовувати це повторно, оскільки ви можете налаштувати [Mail-in-a-Box](https://mailinabox.email)!",
    ...
    "For the Google account to work with this app you need to enable two-factor authentication for Google and generate an app password." : "Щоб акаунт Google міг працювати з цим додатком, вам потрібно увімкнути двофакторну автентифікацію для Google і згенерувати пароль до додатка.",
    ...
    "Testing authentication" : "Тестування автентифікації",
