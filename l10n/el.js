OC.L10N.register(
    ...
    "Looking for a way to encrypt your emails? Install the Mailvelope browser extension!" : "Ψάχτετε τρόπο κρυπτογράφησης των emails σας; Εγκαταστήστε το πρόσθετο Mailvelope στον φυλλομετρητή σας !",
