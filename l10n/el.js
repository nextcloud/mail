OC.L10N.register(
    ...
    "Here you can select where Nextcloud Mail stores your drafts as well as sent and deleted messages." : "Εδώ μπορείτε να επιλέξετε πού αποθηκεύει το Nextcloud Mail τα πρόχειρά σας, καθώς και τα μηνύματα που αποστέλλονται και διαγράφονται.",
    "Draft messages are saved to:" : "Τα πρόχειρα μηνύματα αποθηκεύονται σε:",
    "Sent messages are saved to:" : "Τα απεσταλμένα μηνύματα αποθηκεύονται στο:",
    "Deleted messages are moved to:" : "Τα διαγραμμένα μηνύματα μετακινούνται σε:",
    "Auto" : "Αυτόματα",
    "Name" : "Όνομα",
