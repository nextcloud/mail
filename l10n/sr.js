OC.L10N.register(
    ...
    "We couldn’t load {tag}{name}{endtag}" : "Неуспело учитавање {tag}{name}{endtag}",
    "There was a problem loading {tag}{name}{endtag}" : "Десио се проблем приликом учитавања {tag}{name}{endtag}",
    "We couldn’t load your message" : "Неуспело учитавање поруке",
    "Unable to load the desired message" : "Неуспело учитавање жељене поруке",
    "There was a problem loading the message" : "Десио се проблем приликом учитавања поруке",
    "{from}\n{subject}" : "{from}\n{subject}",
