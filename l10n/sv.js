OC.L10N.register(
    ...
    "Could not fetch delegates" : "Kunde inte hämta delegeringar",
    "Delegated access to {displayName}" : "Delegerad åtkomst till {displayName}",
    "Could not delegate access" : "Kunde inte delegera åtkomst",
    "Revoked access for {displayName}" : "Återkallade tillgång för {displayName}",
    "Could not revoke delegation" : "Kunde inte återkalla delegationen",
    ...
    "could not delete account" : "kunde inte radera konto",
    ...
    "Delegated access to {userId}" : "Delegerade åtkomst till {userId}",
    "Revoked access for {userId}" : "Återkallade tillgång för {userId}"
},
