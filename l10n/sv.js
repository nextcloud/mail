OC.L10N.register(
    ...
    "Mail server configuration mode" : "Konfigurationsläge för e-postserver",
    "Auto" : "Automatisk",
    "Manual" : "Manuellt",
    "Name" : "Namn",
    ...
    "Mark messages as read" : "Markera meddelanden som lästa",
    ...
    "_After %n second_::_After %n seconds_" : ["Efter %n sekund","Efter %n sekunder"],
    ...
    "Cc/Bcc" : "Cc/Bcc",
    "Messages with no 'To' recipients may be rejected by some mail providers." : "Meddelanden utan mottagare i ”Till”-fältet kan avvisas av vissa e-postleverantörer.",
    "Cc" : "Cc",
    "Bcc" : "Bcc",
    "Subject" : "Ämne",
    "Subject …" : "Ämne",
    ...
    "Mark as AI generated" : "Markera som AI-genererat",
    ...
    "Select a mailbox" : "Välj en brevlåda",
    "Choose" : "Välj",
    ...
    "Restore composer" : "Återställ redigeraren",
    "Maximize composer" : "Maximera editor",
    "Minimize composer" : "Minimera editor",
    "Close contact info" : "Stäng kontaktinformationen",
    ...
    "Signature …" : "Signatur …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Den här signaturen är större än 2 MB, vanligen för att en bild är inbäddad i den. Den läggs till i varje meddelande du skickar och kan göra redigeraren långsammare.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Den här signaturen innehåller bilder. Nya meddelanden använder rik text även om skrivläget är inställt på oformaterad text.",
    ...
    "Contains AI content" : "Innehåller AI-innehåll",
    ...
    "Using master user and master password" : "Använder huvudanvändare och huvudlösenord",
    "Using master password for all users" : "Använder huvudlösenord för alla användare",
    ...
    "Without a master user, all users authenticate with their normal username and this master password." : "Utan en huvudanvändare autentiseras alla användare med sitt vanliga användarnamn och detta huvudlösenord.",
    "Master user" : "Huvudanvändare",
    "e.g. {example}" : "t.ex. {example}",
    "Appended to the username. Must start with the same separator as {setting} in Dovecot." : "Läggs till användarnamnet. Måste börja med samma avgränsare som {setting} i Dovecot.",
    "Sieve" : "Sieve",
    ...
    "* %USERID% and %EMAIL% will be replaced with the user's UID and email. {ldapPlaceholder} will be replaced with the value of that LDAP attribute" : "* %USERID% och %EMAIL% ersätts med användarens UID och e-postadress. {ldapPlaceholder} ersätts med värdet för det LDAP-attributet",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Textblock är återanvändbara textstycken som kan infogas i meddelanden. Gå till inställningspanelen för att skapa egna.",
    ...
    "Insert image from Files" : "Infoga bild från Filer",
    "Choose an image" : "Välj en bild",
    "Select an image" : "Markera en bild",
    "Insert {name}" : "Infoga {name}",
    "The selected image is too large to embed" : "Den valda bilden är för stor för att bädda in",
    "Could not insert the selected image" : "Det gick inte att infoga den valda bilden",
    "All" : "Alla",
    "Drafts" : "Utkast",
    ...
    "Date:" : "Datum:",
    "Printing from the browser menu is not supported" : "Utskrift från webbläsarens meny stöds inte",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "För att skriva ut e-postmeddelandet trycker du på {shortcut}, eller använder åtgärden ”Skriv ut meddelande” i meddelandemenyn.",
