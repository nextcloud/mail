OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!" : "**💌 En e-postapplikation för Nextcloud**\n\n- **🚀 Integration med andra Nextcloud-appar!** För nuvarande Kontakter, Kalender & Filer – fler på gång.\n- **📥 Flera e-postkonton!** Både personligt och företagskonto? Inga problem med en smidig samlad inkorg. Anslut alla sorters IMAP-konton.\n- **🔒 Skicka och ta emot krypterade meddelanden!** Använd det förträffliga webbläsartillägget [Mailvelope](https://mailvelope.com).\n- **🙈 Vi återuppfinner inte hjulet!** Baserat på [Horde](https://horde.org)-biblioteken.\n- **📬 Vill du ha en egen e-postserver?** Vi behöver inte återimplementera detta då du kan skaffa [Mail-in-a-Box](https://mailinabox.email)!",
