OC.L10N.register(
    ...
    "The folders to use for drafts, sent messages, deleted messages and archived messages." : "Složky které použít pro koncepty, odeslané, smazané a archivované zprávy.",
    ...
    "Sign message via S/MIME" : "Podepsat zprávu pomocí S/MIME",
    ...
    "Only PEM encoded certificates and private keys are supported. PKCS #12 certificates (.p12 files) can't be imported and need to be converted." : "Podporovány jsou pouze certifikáty a klíče v kódování PEMencoded. PKCS #12 certifikáty (.p12 files) není možné přímo importovat a je třeba je předtím převést.",
    "Back" : "Zpět",
    "Submit" : "Odeslat",
