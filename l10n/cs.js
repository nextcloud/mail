OC.L10N.register(
    ...
    "Allow the app to collect data about your interactions. Based on this data, the app will adapt to your preferences. The data will only be stored locally." : "Umožnit aplikaci shromažďovat data o vaší interakci s ní. Na základě nic se aplikace přizpůsobí vašim preferencím. Data budou ukládána pouze lokálně.",
    "From" : "Od",
    ...
    "Unselect " : "Zrušit výběr",
    "Delete " : "Smazat",
    "Show all {nr} messages" : "Zobrazit všech {nr} zpráv",
    "Collapse messages" : "Sbalit správy",
    ...
    "Forward" : "Přeposlat",
    "Mark not junk" : "Zrušit označení jako nepořádek",
    "Mark junk" : "Označit jako nepořádek",
