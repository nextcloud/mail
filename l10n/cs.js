OC.L10N.register(
    ...
    "TextBlock deleted" : "Textový blok smazán",
    "Failed to delete textBlock" : "Nepodařilo se smazat textový blok",
    "TextBlock shared with {sharee}" : "Textový blok nasdílen {sharee}",
    "Failed to share textBlock with {sharee}" : "Nepodařilo se nasdílet textový blok uživateli {sharee}",
    "Share deleted for {name}" : "Sdílení s {name} smazáno",
    "Failed to delete share with {name}" : "Nepodařilo se smazat sdílení s {name}",
    "Guest" : "Host",
    "Group" : "Skupina",
    "Failed to save textBlock" : "Nepodařilo se uložit textový blok",
    "Shared" : "Sdíleno",
    "Edit {title}" : "Upravit {title}",
    "Delete {title}" : "Smazat {title}",
    "Edit text block" : "Upravit textový blok",
    "Title of the textBlock" : "Nadpis textového bloku",
    "Content of the textBlock" : "Obsah textového bloku",
    "Shares" : "Sdílení",
