OC.L10N.register(
    ...
    "Can not save draft because this account does not have a drafts mailbox configured." : "Koncept nelze uložit, protože tento účet nemá nakonfigurovanou schránku konceptů.",
    ...
    "_Mark {number} unread_::_Mark {number} unread_" : ["Označit {number} jako nepřečtený","Označit {number} jako nepřečtené","Označit {number} jako nepřečtené","Označit {number} jako nepřečtené"],
    ...
    "_Favorite {number}_::_Favorite {number}_" : ["Přidat k oblíbeným {number}","Přidat k oblíbeným {number}","Přidat k oblíbeným {number}","Přidat k oblíbeným {number}"],
    "_Unselect {number}_::_Unselect {number}_" : ["Zrušit výběr {number}","Zrušit výběr {number}","Zrušit výběr {number}","Zrušit výběr {number}"],
    "_Move {number}_::_Move {number}_" : ["Přesunout {number}","Přesunout {number}","Přesunout {number}","Přesunout {number}"],
    ...
    "_Delete {number}_::_Delete {number}_" : ["Smazat {number}","Smazat {number}","Smazat {number}","Smazat {number}"],
    ...
    "Cancel" : "Storno",
    "Show all subscribed mailbox" : "Zobrazit všechny přihlášené poštovní schránky",
