OC.L10N.register(
    ...
    "Mails" : "Correos-e",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following emails: %3$s" : "Correo electrónico do remitente: %1$s non está no caderno de enderezos, mais o nome do remitente: %2$s está no caderno de enderezos cos seguintes correos electrónicos: %3$s",
    "Sender is using a custom email: %1$s instead of the sender email: %2$s" : "O remitente está a usar un correo personalizado: %1$s no canto dun correo do remitente: %2$s",
    "Sent date is in the future" : "A data de envío está no futuro",
    "Reply-To email: %1$s  is different from the sender email: %2$s" : "Correo electrónico de resposta: %1$s é diferente do correo do remitente: %2$s",
    ...
    "Activate body search" : "Activar a busca no corpo do correo",
    ...
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Editar as etiquetas para {número}","Editar as etiquetas para {número}"],
    ...
    "Port" : "Porto",
    "SMTP" : "SMTP",
    "Master password" : "Contrasinal mestre",
    "Use master password" : "Usar o contrasinal mestre",
    "Sieve" : "Peneira",
