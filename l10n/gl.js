OC.L10N.register(
    ...
    "Please enter an email of the format name@example.com" : "Introduza un correo-e co formato nome@exemplo.com",
    ...
    "Configuration discovery failed. Please use the manual settings" : "Produciuse un fallo ao descubrir a configuración. Use os axustes manuais",
    ...
    "Warning: The S/MIME signature of this message is unverified. The sender might be impersonating someone!" : "Aviso: a sinatura S/MIME desta mensaxe non está verificada. É posíbel que o remitente estea a suplantar a identidade de alguén.",
    ...
    "An error occurred, unable to rename the tag." : "Produciuse un erro, non foi posíbel cambiar o nome da etiqueta.",
    ...
    "Microsoft allows users to access their email via IMAP. For security reasons this access is only possible with an OAuth 2.0 connection." : "Microsoft permítelle aos usuarios acceder ao seu correo a través de IMAP. Por mor da seguridade, este acceso só é posíbel cunha conexión OAuth 2.0.",
    ...
    "Reset" : "Restabelecer",
    "Successfully set up anti spam email addresses" : "Configurar correctamente os enderezos de correo anti-spam",
