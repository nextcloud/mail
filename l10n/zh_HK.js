OC.L10N.register(
    ...
    "Mark {number} unread" : "將 {number} 標記為未讀",
    "Mark {number} read" : "將 {number} 標記為已讀",
    "Unfavorite {number}" : "取消我的最愛 {number}",
    "Favorite {number}" : "我的最愛 {number}",
    "Unselect {number}" : "取消選取 {number}",
    "Move {number}" : "移動 {number}",
    "Forward {number} as attachment" : "轉發 {number} 作為附件",
    "Delete {number}" : "刪除 {number}",
    "Load more" : "載入更多",
    ...
    "Show images from this sender" : "顯示來自此寄件人的圖片",
    "Message frame" : "郵件框",
    "Quoted text" : "引用文字",
    "Moving" : "正在移動",
    "New message" : "新郵件",
    ...
    "Cancel" : "取消",
    "Show all subscribed mailbox" : "顯示所有已訂閱的信箱",
