OC.L10N.register(
    ...
    "Messages that your mark as favorite will be shown at the top of folders. You can disable this behavior in the app settings" : "你標記為最愛的訊息將會顯示在各自資料夾的頂部。你可以在應用程式設置中停用此功能",
