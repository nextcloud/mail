OC.L10N.register(
    ...
    "There can only be one configuartion per domain, and only one wildcard domain configuration." : "每個網域只能有一種配置，並且只能有一種通配符網域配置。",
    "These settings can be used in conjuction with each other." : "這些設置可以相互結合使用。",
    ...
    "Successfully provisioned {count} accounts." : "成功配置 {count} 個賬戶。",
    "There was an error when provisioning accounts." : "配置賬戶時出錯。",
    "Sucessfully deleted and deprovisioned accounts for \"{domain}\"" : "已成功刪除和取消配置 “{domain}” 的賬戶",
