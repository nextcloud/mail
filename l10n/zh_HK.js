OC.L10N.register(
    ...
    "TextBlock deleted" : "文本區塊已刪除",
    "Failed to delete textBlock" : "刪除文本區塊失敗",
    "TextBlock shared with {sharee}" : "已與 {sharee} 分享文本區塊",
    "Failed to share textBlock with {sharee}" : "無法與 {sharee} 分享文本區塊",
    "Share deleted for {name}" : "{name}的分享已被刪除",
    "Failed to delete share with {name}" : "未能刪除 {name} 的分享",
    "Guest" : "訪客",
    "Group" : "群組",
    "Failed to save textBlock" : "保存文本區塊失敗",
    "Shared" : "已分享",
    "Edit {title}" : "編輯 {title}",
    "Delete {title}" : "刪除 {title}",
    "Edit text block" : "編輯文本區塊",
    "Title of the textBlock" : "文本區塊標題",
    "Content of the textBlock" : "文本區塊內容",
    "Shares" : "分享",
    "Search for users or groups" : "搜尋用戶或是群組",
    "Choose a text block to insert at the cursor" : "選擇一個文本區塊以在游標處插入",
    "Insert" : "插入",
    "Inset text block" : "插入文本區塊",
