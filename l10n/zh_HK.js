OC.L10N.register(
    ...
    "Mailvelope is enabled for the current domain!" : "Mailvelope 已在當前域名啟用！",
    ...
    "Enable Mailvelope for the current domain" : "為當前域名啟用 Mailvelope",
    ...
    "Please login using a password to enable this account. The current session is using passwordless authentication, e.g. SSO or WebAuthn." : "請使用密碼登錄以啟用此帳戶。當前會話正在使用無密碼身份驗證，例如 SSO 或 WebAuthn。",
    "Quota" : "用量",
