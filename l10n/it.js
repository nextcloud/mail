OC.L10N.register(
    ...
    "Can not save draft because this account does not have a drafts mailbox configured." : "Impossibile salvare la bozza perché questo account non dispone di una casella delle bozze configurata.",
    ...
    "_Move {number}_::_Move {number}_" : ["Sposta {number}","Sposta {number}"],
    "_Forward {number} as attachment_::_Forward {number} as attachment_" : ["Inoltra {number} come allegato","Inoltra {number} come allegati"],
    "_Delete {number}_::_Delete {number}_" : ["Elimina {number}","Elimina {number}"],
    ...
    "Cancel" : "Annulla",
    "Show all subscribed mailbox" : "Mostra tutte le caselle di posta sottoscritte",
