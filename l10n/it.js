OC.L10N.register(
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://horde.org) libraries.\n- **📬 Want to host your own mail server?** We don’t have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!" : "**💌 Un'applicazione di posta elettronica per Nextcloud**\n\n- **🚀 Integrazione con altre applicazioni Nextcloud!** Attualmente Contatti, Calendario e File – altri sono in arrivo.\n- **📥 Account di posta elettronica multipli!** Account personale e aziendale? Nessun problema e una bella casella di posta elettronica unificata. Collega qualsiasi account IMAP.\n- **🔒 Invia e ricevi e-mail crittografate!** Usa la fantastica estensione del browser [Mailvelope](https://mailvelope.com).\n- **🙈 Non stiamo reinventando la ruota!** Basato sulle fantastiche librerie di [Horde](https://horde.org).\n- **📬 Vuoi ospitare il tuo server di posta?** Non è necessario reimplementarlo poiché potresti configurare [Mail-in-a-Box](https://mailinabox.email)!",
    ...
    "_Mark {number} unread_::_Mark {number} unread_" : ["Marca {number} come non letto","Marca {number} come non letti"],
    "_Mark {number} read_::_Mark {number} read_" : ["Marca {number} come letto","Marca {number} come letti"],
    "_Mark {number} as important_::_Mark {number} as important_" : ["Marca {number} come importante","Marca {number} come importante"],
    "_Mark {number} as unimportant_::_Mark {number} as unimportant_" : ["Marca {number} come non importante","Marca {number} come non importante"],
    ...
    "Choose" : "Scegli",
    "Important and unread" : "Importanti e non letti",
    ...
    "_Successfully provisioned {count} account._::_Successfully provisioned {count} accounts._" : ["Approvvigionamento di {count} account completato con successo.","Approvvigionamento di {count} account completato con successo."],
    "Anti Spam" : "Anti-Spam",
