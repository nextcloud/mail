...
* **attachements:** unify icons with the rest of nextcloud ([d225fcb](https://github.com/nextcloud/mail/commit/d225fcbc9a558f407f6b3b7e039e18e11066ecfa))
* **ckeditor:** Better matching for CKEditor translations ([c200b57](https://github.com/nextcloud/mail/commit/c200b5746b4ba0a04c41f3d2bc051c8e77aa7ab0))
* **composer:** Forwarding emails with attachments ([bb179dc](https://github.com/nextcloud/mail/commit/bb179dce5a9aebcc0c31b039cb76244a0e4e6b45))
* **contactsIntegration:** avoid incorrect cache results ([bb87a12](https://github.com/nextcloud/mail/commit/bb87a12088d6534c04637ab46edcaea7526700a2))
* **contacts:** Use correct default for shareapi_allow_share_dialog_user_enumeration ([e874458](https://github.com/nextcloud/mail/commit/e87445870e706cf86443878956e7980bb5000abe))
* **l10n:** Update translations from Transifex ([ed79d50](https://github.com/nextcloud/mail/commit/ed79d50536950d52cbaa7b4bfc68e10a84cda773))
* **l10n:** Update translations from Transifex ([faa9d89](https://github.com/nextcloud/mail/commit/faa9d890b42a328bfdbb664f50bb32734a3e4b9f))
* **l10n:** Update translations from Transifex ([f511dfb](https://github.com/nextcloud/mail/commit/f511dfb66e0b3e61e9770755f382113b57b03899))
* **l10n:** Update translations from Transifex ([b86ea0d](https://github.com/nextcloud/mail/commit/b86ea0d1da8fd60ce785a57a3c5cfa99a2039954))
* **l10n:** Update translations from Transifex ([c2f7962](https://github.com/nextcloud/mail/commit/c2f79626f9711876b83858a4a41651db4b00fbd3))
* **l10n:** Update translations from Transifex ([8776f75](https://github.com/nextcloud/mail/commit/8776f75425d2e84817dfcfad24a1f026f186e8b2))
* **oauth:** do not force a Microsoft 365 consent ([a0e59b6](https://github.com/nextcloud/mail/commit/a0e59b68ccd426f78462eda2925e6065dd749a9b))
* quick search filters ([95b54d9](https://github.com/nextcloud/mail/commit/95b54d90268c96b0a38150a4798c715db1793539))
* thread scrolling position ([59013de](https://github.com/nextcloud/mail/commit/59013de5b14f702e1274c6d0c56c76423cddc2a8))



# [5.7.0](https://github.com/nextcloud/mail/compare/v5.7.0-rc.2...v5.7.0) (2026-02-16)


### Bug Fixes

* **dns:** Update public suffix list ([0353201](https://github.com/nextcloud/mail/commit/03532012f3cdc6c601686c36ed3fb30cdb8b6903))
* **imap:** log partial sync criteria ([b2ad48b](https://github.com/nextcloud/mail/commit/b2ad48b7789c6fe839ed154fa76ae598a80c97e1))
* **l10n:** Update translations from Transifex ([8df34fc](https://github.com/nextcloud/mail/commit/8df34fc9d4f7bf675acd2c0e67a583894d0bc5b8))
* **l10n:** Update translations from Transifex ([3f2594c](https://github.com/nextcloud/mail/commit/3f2594c49d747820b8db1aa831457c409d452f7e))
* **l10n:** Update translations from Transifex ([6334921](https://github.com/nextcloud/mail/commit/63349215efafb52d65d7f4ba9b6cd6b7def8831d))
* **l10n:** Update translations from Transifex ([fc3bb90](https://github.com/nextcloud/mail/commit/fc3bb90799bbb96a5491936d9393ae89f253dc3c))
* Pass actual message body to dompurify ([4efb610](https://github.com/nextcloud/mail/commit/4efb6101294ad07f7e536d62eaef8e6c3a6e5514))
* unlock mailboxes after OOM ([2c14470](https://github.com/nextcloud/mail/commit/2c144703f97335bde92cea1730f7ae4417c81fc6))



# [5.7.0-rc.2](https://github.com/nextcloud/mail/compare/v5.7.0-rc.1...v5.7.0-rc.2) (2026-02-10)


### Bug Fixes

* **account:** use classification state from account ([3d33c3c](https://github.com/nextcloud/mail/commit/3d33c3cf8ade2f267bcad3550fae2d143e59e275))
* **attachementNames:** lower log level ([3db33fd](https://github.com/nextcloud/mail/commit/3db33fd6f53f6dd55126862297aa6b4249ccb129))
* clean text blocks on user deletion ([b80ab5e](https://github.com/nextcloud/mail/commit/b80ab5eab6ac12ec477b0d55bfe29c57c6e7d1d3))
* **composer:** handle missing message body gracefully ([bcf4ab2](https://github.com/nextcloud/mail/commit/bcf4ab20457a0b1eeb61373f6a9477a02431a379))
* **Composer:** make initial focus be on to field ([5826bf6](https://github.com/nextcloud/mail/commit/5826bf637f2ae500626690f1f707059a15ff186e))
* **deps:** Fix npm audit ([5a70e96](https://github.com/nextcloud/mail/commit/5a70e9623dc9160f84174dafdccbfe4a3c4185bd))
* **dns:** Update public suffix list ([384108e](https://github.com/nextcloud/mail/commit/384108efcaae51b4d2c8daa1ebae9e6ac140660c))
* **l10n:** Update translations from Transifex ([99680db](https://github.com/nextcloud/mail/commit/99680db7196ea999ac3fbe6e6170655c7a529b65))
* **l10n:** Update translations from Transifex ([38571ec](https://github.com/nextcloud/mail/commit/38571ec6312f665ecd36035be81811086fec73c3))
* **l10n:** Update translations from Transifex ([58e9870](https://github.com/nextcloud/mail/commit/58e9870620ddb1f3f79fe33a95be9b1f86f7e3ba))
* **l10n:** Update translations from Transifex ([358c922](https://github.com/nextcloud/mail/commit/358c9228a9fd69ee97e2232d58633e4f65a028f1))
* **l10n:** Update translations from Transifex ([c529177](https://github.com/nextcloud/mail/commit/c529177edd8672487e53b486a62e66ecf6fdbddc))
* **l10n:** Update translations from Transifex ([b08c57d](https://github.com/nextcloud/mail/commit/b08c57d4bbc4e174601c2c0692c1b34e1dca2ef4))
* **l10n:** Update translations from Transifex ([eeb8bd5](https://github.com/nextcloud/mail/commit/eeb8bd59faf73f73c92f111391e51f74e10b3dd6))
* **l10n:** Update translations from Transifex ([7634708](https://github.com/nextcloud/mail/commit/7634708c99b1f5c7205db97381ea63ccbceed92d))
* **l10n:** Update translations from Transifex ([19b1805](https://github.com/nextcloud/mail/commit/19b180501c633f3a6ad3895aaabe01e4c421d596))
* **l10n:** Update translations from Transifex ([5662d8b](https://github.com/nextcloud/mail/commit/5662d8bcd92ff6564d50cffe27e53964c4d4b942))
* **l10n:** Update translations from Transifex ([e4b7a66](https://github.com/nextcloud/mail/commit/e4b7a6647dc05be11f3ffecfa92902d40af98813))
* **l10n:** Update translations from Transifex ([0baca3b](https://github.com/nextcloud/mail/commit/0baca3b3bc6c5a54e2c0ffba2a8d7f12beab83cc))
* only showing classification check box in setup form ([735d0f0](https://github.com/nextcloud/mail/commit/735d0f0b21704d161b0a24610458bc2881dfc065))
* **provisioning:** Do not provision users without access to mail app ([b6c3691](https://github.com/nextcloud/mail/commit/b6c3691a825f940b3a831cf8baaceda55d30a6b3))
