...
* **dns:** Update public suffix list ([91a956b](https://github.com/nextcloud/mail/commit/91a956b6e90d2c6d9155915efe51a9aa08b23b09))
* **imap:** declare UTF-8 charset for IMAP search queries ([b500c6a](https://github.com/nextcloud/mail/commit/b500c6a507890dcf8867574e8d6cea33fb4d6564))
* **l10n:** Update translations from Transifex ([8787bed](https://github.com/nextcloud/mail/commit/8787bed6807bb477944787bc4ff9e6659c844cd7))
* **l10n:** Update translations from Transifex ([97f118b](https://github.com/nextcloud/mail/commit/97f118bbca568ca73fd1c51a1fc804818ae670d7))
* **l10n:** Update translations from Transifex ([0e60045](https://github.com/nextcloud/mail/commit/0e600457cd77dcc769f658d3324ed819ffffdbe4))
* **l10n:** Update translations from Transifex ([7825272](https://github.com/nextcloud/mail/commit/78252728fca5915e82bdd83085f49a357674f8df))
* **l10n:** Update translations from Transifex ([69bbe25](https://github.com/nextcloud/mail/commit/69bbe2547f8fb378f9db1eb518e181b06bfc92fc))
* **l10n:** Update translations from Transifex ([33c2b6d](https://github.com/nextcloud/mail/commit/33c2b6ded20d566715765f40a4d9372723f0bb63))
* **l10n:** Update translations from Transifex ([23e1250](https://github.com/nextcloud/mail/commit/23e1250b3c4b5d5aeffb4a0aff344931926570f4))
* **l10n:** Update translations from Transifex ([aa011de](https://github.com/nextcloud/mail/commit/aa011de8f0143dcba50f9998eb0a0fb923fee436))
* **l10n:** Update translations from Transifex ([b20218d](https://github.com/nextcloud/mail/commit/b20218d810c741fba15ad9015df9946139128160))
* **l10n:** Update translations from Transifex ([b4ab13b](https://github.com/nextcloud/mail/commit/b4ab13b48152de8cb3275d9563752a3b074905a2))
* **l10n:** Update translations from Transifex ([10d051e](https://github.com/nextcloud/mail/commit/10d051e0991fc40792c59a5abf2dc5e9a962fc80))
* **l10n:** Update translations from Transifex ([3614743](https://github.com/nextcloud/mail/commit/361474347f4daaf0cbe1b5198f00551406627484))
* **l10n:** Update translations from Transifex ([aa47d03](https://github.com/nextcloud/mail/commit/aa47d03c169b2f5007bfd88509a13816b87eabb9))
* **l10n:** Update translations from Transifex ([19ddafb](https://github.com/nextcloud/mail/commit/19ddafbda0f173a91639ae85376e347d312c0db1))
* **l10n:** Update translations from Transifex ([3301faf](https://github.com/nextcloud/mail/commit/3301faf9846fef11bc2cbee08f4db571da0ca406))
* **l10n:** Update translations from Transifex ([6dd5c08](https://github.com/nextcloud/mail/commit/6dd5c08cb5f4e429f04d273d6fa4adc8cfd54eea))
* **provisioning:** Add support for Dovecot master user authentication ([e5057bb](https://github.com/nextcloud/mail/commit/e5057bbca0bf90646100c6b9022ee1e2046edb47))
* **provisioning:** Flag port as faulty instead of host ([fd2966f](https://github.com/nextcloud/mail/commit/fd2966f9c4f99b94adc93a332bc52b33147802c0))
* shareapi config key name ([7de29b2](https://github.com/nextcloud/mail/commit/7de29b2a0079c012902d122cbac52a49e1c26d8f))
* **sieve:** Add redirect action ([c1ea978](https://github.com/nextcloud/mail/commit/c1ea978618dce0fe6e8cb42ce855cbacebd57a8f))
* swap the FilePicker component for the builder ([70d2111](https://github.com/nextcloud/mail/commit/70d211191847e69589199ccde99e14b194f3b822))
* **ui:** load more messages without scrolling ([05ea37d](https://github.com/nextcloud/mail/commit/05ea37dda6e93daf57db04b84e477897b7656c1e))
* **ui:** move blocked images notice out of the message body ([57e8308](https://github.com/nextcloud/mail/commit/57e8308fc066c34e58937e20b1768b2f52d9c706))


### Performance Improvements

* **db:** load local-message children via PK join ([6da204c](https://github.com/nextcloud/mail/commit/6da204c5476c4e7c0dbad6d70204d94fe4fc8340))



# [5.12.0-rc.1](https://github.com/nextcloud/mail/compare/v5.12.0-beta.2...v5.12.0-rc.1) (2026-09-03)


### Bug Fixes

* avatar size on hover ([7bfe6ca](https://github.com/nextcloud/mail/commit/7bfe6ca74dc9cd6d6841ab7cfd3b801e8adb22cd))
* **delegation:** check if delegated user has access to destination mailbox ([5b97069](https://github.com/nextcloud/mail/commit/5b97069fefdea9cb7fdb7c10348a683287fb14e0))
* **dns:** Update public suffix list ([17d604d](https://github.com/nextcloud/mail/commit/17d604d4a5af0fcea815a06bf20f8b1b949c67f9))
* **imap:** handle korean Windows encoding ks_c_5601-1987/ks_c_5601-1989 ([5131dac](https://github.com/nextcloud/mail/commit/5131dac54956d6e0959ac3070b174133eafe343c))
* **l10n:** Update translations from Transifex ([4f0c569](https://github.com/nextcloud/mail/commit/4f0c5697f3523d7f47899b52bd011c71fdec4c32))
* **l10n:** Update translations from Transifex ([801e811](https://github.com/nextcloud/mail/commit/801e8116fa304af17010fa572135de24fe2ee58e))
* **sieve:** terminate installed scripts with CRLF ([80ff3ce](https://github.com/nextcloud/mail/commit/80ff3ce715cdf3e52c71a4083fc75c3c426548af))


### Features

* ability to disable sync job by configuration ([3788f4d](https://github.com/nextcloud/mail/commit/3788f4d4d7d03936f6a7cd9354b2a5f7599321d4))


### Performance Improvements

* **db:** index the mailbox list sort ([d86b644](https://github.com/nextcloud/mail/commit/d86b644b8d2f8e225a4fb65ba489c76bbd0f0587))
* **internal-address:** prefix userId in the idx ([f4b88ab](https://github.com/nextcloud/mail/commit/f4b88ab99bdbec9f3645e3aeaab5763668160932))



# [5.12.0-beta.2](https://github.com/nextcloud/mail/compare/v5.12.0-beta.1...v5.12.0-beta.2) (2026-08-31)


### Bug Fixes

* **composer:** remove duplicate Cc/Bcc button ([1723209](https://github.com/nextcloud/mail/commit/1723209e396d7f1608ced1a2b209719cfc6b5962))
* **deps:** bump @nextcloud/cdav-library from ^2.6.2 to ^2.7.0 ([#13562](https://github.com/nextcloud/mail/issues/13562)) ([477b331](https://github.com/nextcloud/mail/commit/477b33192f53e47be5e85e865f7c29dd29354861))
* **deps:** bump @nextcloud/vue from ^8.40.0 to ^8.41.0 ([1d4c42f](https://github.com/nextcloud/mail/commit/1d4c42fc8de81b8312e21f60dd723229a4732c06))
* **deps:** bump core-js from ^3.49.0 to ^3.50.0 ([#13563](https://github.com/nextcloud/mail/issues/13563)) ([695c1cd](https://github.com/nextcloud/mail/commit/695c1cdc0cddeaa2032f414b9ebc3c25aceb27d8))
* **deps:** bump js-base64 from ^3.8.0 to ^3.9.3 ([#13564](https://github.com/nextcloud/mail/issues/13564)) ([51a6df8](https://github.com/nextcloud/mail/commit/51a6df865e4293fbccaa71668172f6b0b3531dda))
* **deps:** bump rubix/ml from 2.5.4 to v2.5.5 ([#13573](https://github.com/nextcloud/mail/issues/13573)) ([23670fb](https://github.com/nextcloud/mail/commit/23670fba39fcc9fe7af26f8177fcaa3885cbf6e9))
* **deps:** bump uuid from ^14.0.1 to ^14.0.2 ([#13575](https://github.com/nextcloud/mail/issues/13575)) ([f691568](https://github.com/nextcloud/mail/commit/f691568c6131c7241451a8be70334285400196f8))
* draft reset when click outside ([30de189](https://github.com/nextcloud/mail/commit/30de1894127ea2269b8e7e7880a886b6cb0463f6))
* **l10n:** Update translations from Transifex ([38ea343](https://github.com/nextcloud/mail/commit/38ea343f3d4ac96c810d070af381b8d05b3404ab))
* **l10n:** Update translations from Transifex ([652c64f](https://github.com/nextcloud/mail/commit/652c64fc8f9f43f166380bf5b61de2bb5c15b7b1))
* **l10n:** Update translations from Transifex ([098b0c4](https://github.com/nextcloud/mail/commit/098b0c46b009f17a7bcbe782a2f74869532c9665))
* **l10n:** Update translations from Transifex ([081489c](https://github.com/nextcloud/mail/commit/081489cd9fb622364d7e85188ef1627a92cf39b6))
* **l10n:** Update translations from Transifex ([12d4b0d](https://github.com/nextcloud/mail/commit/12d4b0daa422ed8268119687b044fd27e6504858))
* **l10n:** Update translations from Transifex ([d6c81b8](https://github.com/nextcloud/mail/commit/d6c81b81dea6701fa6b6039b6981b86f6b6e8949))
* mail printing with hidden images ([bbefc5f](https://github.com/nextcloud/mail/commit/bbefc5ff3508ed4b77f0fb4dd77fa6aee03d304d))
* **translateText:** add termination condition ([a5e384a](https://github.com/nextcloud/mail/commit/a5e384a59e4bcb1d006940016b58080481c0a816))


### Features

* **deps:** add Nextcloud 36 support ([a758dd7](https://github.com/nextcloud/mail/commit/a758dd7f171f854b9ee735f4d62e9fadec147230))
* **provisioning:** Add possibility to use LDAP attributes within provisioning templates ([a8312c6](https://github.com/nextcloud/mail/commit/a8312c6600045e812c603c29403026cc0e471111))



# [5.12.0-beta.1](https://github.com/nextcloud/mail/compare/v5.11.0-beta.3...v5.12.0-beta.1) (2026-08-25)


### Bug Fixes

* actions for special folders ([#13498](https://github.com/nextcloud/mail/issues/13498)) ([10d335e](https://github.com/nextcloud/mail/commit/10d335e86a735851fc4c484f85a0dbd6f9fe345b)), closes [#9106](https://github.com/nextcloud/mail/issues/9106)
* add sandbox for iframe ([90a74e4](https://github.com/nextcloud/mail/commit/90a74e45d1dd16fec953f5dbe48c598dc1177ea1))
* allow scripts in message iframe sandbox so the body resizes ([34935aa](https://github.com/nextcloud/mail/commit/34935aa945cdef543e41bcf8d8810adfa08a6c1c)), closes [#13088](https://github.com/nextcloud/mail/issues/13088) [#13527](https://github.com/nextcloud/mail/issues/13527)
* **attachments:** don't preview attachments when viewer app is disabled ([5cd0b5e](https://github.com/nextcloud/mail/commit/5cd0b5e94eb000c198e58f44fc90b5fa2e616c69))
* buttons alignment and minor graphic fixes in signature editor ([e1f76c6](https://github.com/nextcloud/mail/commit/e1f76c62cd2cf5332354d20351dbd641922d0820))
* checking permissions while selecting folder for quick action ([1faee39](https://github.com/nextcloud/mail/commit/1faee3910438975383e37b026dd501d495094948))
* **composer:** keep resized image dimensions in sent messages ([c6ea817](https://github.com/nextcloud/mail/commit/c6ea817ea7b843507c14020f04970d01901b85ed))
* **composer:** only warn about missing 'To' when cc/bcc are set ([6e414b2](https://github.com/nextcloud/mail/commit/6e414b213463f48fd838db524604f3f6029efe23))
* **dav:** use the default webdav client instead of patching axios ([3d24f04](https://github.com/nextcloud/mail/commit/3d24f04c8aec6fb4abb17b538898009dfdae100a))
* **deps:** bump @nextcloud/vue from ^8.39.0 to ^8.40.0 ([2408eeb](https://github.com/nextcloud/mail/commit/2408eeb5f7903b472a9f82b0d806d80b61a4b388))
* **deps:** bump dompurify from ^3.4.11 to ^3.4.13 ([#13550](https://github.com/nextcloud/mail/issues/13550)) ([1f48475](https://github.com/nextcloud/mail/commit/1f48475246ae4ae757cb0434e84134041084b1af))
* **deps:** bump dompurify from ^3.4.11 to v3.4.13 ([7a16787](https://github.com/nextcloud/mail/commit/7a16787f281665a0b993559b515b98f51345a0da))
* **deps:** bump p-limit from ^7.3.0 to ^7.3.1 ([#13551](https://github.com/nextcloud/mail/issues/13551)) ([603cf91](https://github.com/nextcloud/mail/commit/603cf916383106f9d4f1daa0afed7f07f8b76e27))
* **deps:** bump rubix/ml from 2.5.3 to v2.5.4 ([#13552](https://github.com/nextcloud/mail/issues/13552)) ([5b71bbb](https://github.com/nextcloud/mail/commit/5b71bbb2765f7d0f213bb219725e0dc9056a094c))
* **deps:** bump stylelint from ^17.14.0 to ^17.14.1 ([#13553](https://github.com/nextcloud/mail/issues/13553)) ([826b024](https://github.com/nextcloud/mail/commit/826b0241468ae3eed77e13147fd598d10e57ba23))
* **deps:** Fix npm audit ([3b9ba00](https://github.com/nextcloud/mail/commit/3b9ba000bd58bd2ed7bf22e0be53d4cbccf1bcde))
* enabling html ids inside email body to permit css targetting ([3a0ce99](https://github.com/nextcloud/mail/commit/3a0ce99001b524b161a9126cd4fb07fe8d0c0c56))
* **imap:** skip fetch results without a UID during sync ([6f9b14a](https://github.com/nextcloud/mail/commit/6f9b14af9a92a1f0f45eee780f9e5aa5fb8e3d3f))
* **l10n:** Update translations from Transifex ([6ea9f42](https://github.com/nextcloud/mail/commit/6ea9f425ff4b1488431844ea5bd7e03b4b882520))
* **l10n:** Update translations from Transifex ([c28e050](https://github.com/nextcloud/mail/commit/c28e0508bef04f70aa7cff07ca93694b747aafd8))
* **l10n:** Update translations from Transifex ([c685cdf](https://github.com/nextcloud/mail/commit/c685cdf03b80e3e9502d54d0a7599f404bae096e))
* **l10n:** Update translations from Transifex ([e5734fe](https://github.com/nextcloud/mail/commit/e5734fe250eba06776802c80bb0e52f3cb625673))
* **l10n:** Update translations from Transifex ([c5a4760](https://github.com/nextcloud/mail/commit/c5a47603a5717403c5deab55dd7a1c980b773666))
* **l10n:** Update translations from Transifex ([0a46907](https://github.com/nextcloud/mail/commit/0a469072c438fce4692b06e386e38aa77b3fe0ad))
* **l10n:** Update translations from Transifex ([f3323dc](https://github.com/nextcloud/mail/commit/f3323dc8c8627a3a2f10a271ebf5523ef79703c5))
* **l10n:** Update translations from Transifex ([7e34b55](https://github.com/nextcloud/mail/commit/7e34b552e8b221265dd557e97fbeaaa41decb8ed))
* **l10n:** Update translations from Transifex ([3a7fb11](https://github.com/nextcloud/mail/commit/3a7fb110805364e2384419a7457a1a4c5f6ff934))
* **l10n:** Update translations from Transifex ([c7cf4fb](https://github.com/nextcloud/mail/commit/c7cf4fba28f550c9b0d72745085fae41f96629ae))
* **l10n:** Update translations from Transifex ([7ffc781](https://github.com/nextcloud/mail/commit/7ffc7816fc013eec7b9e99888f04da79680ecc4f))
* **l10n:** Update translations from Transifex ([0261197](https://github.com/nextcloud/mail/commit/0261197a48ae0f2e3d8c6026db03eb59df983e4e))
* **l10n:** Update translations from Transifex ([d77e439](https://github.com/nextcloud/mail/commit/d77e4399aeeb0f51c11d2e9f230f58c8b0da0bad))
* **l10n:** Update translations from Transifex ([c385780](https://github.com/nextcloud/mail/commit/c3857804dce92fe05542cf57d23407d25eddf7c0))
* **l10n:** Update translations from Transifex ([1968041](https://github.com/nextcloud/mail/commit/1968041ebcbd120bfce97be65d40fe636428252b))
* **migration:** heal legacy non-bool appconfig values ([f4d0c12](https://github.com/nextcloud/mail/commit/f4d0c12af58acb85dac4bdc2839142ee434e3f45))
* **migration:** support the new OCP DB schema API ([b5283cf](https://github.com/nextcloud/mail/commit/b5283cf1be092b55a4112e008b3e30c46b9669d4))
* minor adjustment in moving messages, threads and folders ([4b7d231](https://github.com/nextcloud/mail/commit/4b7d2311886f41fbd44413e0e406ca970d2c4309))
* **navigation:** show the unified inbox icon ([5b76052](https://github.com/nextcloud/mail/commit/5b76052296a7b53543dd9c93bad2f59af5d0390b))
* **proxy:** preserve percent-encoded image URLs in proxy link ([6ee86ed](https://github.com/nextcloud/mail/commit/6ee86ed1cd2b90a09c2736c29f6c44eeca2be085))
* **psalm:** resolve type issues ahead of the Psalm 6 upgrade ([ca95cb3](https://github.com/nextcloud/mail/commit/ca95cb3d554342d8f9dcfbe7cd828a711693f0f7)), closes [#11224](https://github.com/nextcloud/mail/issues/11224)
* **settings:** mount account-settings dialog at app root ([6c9dc30](https://github.com/nextcloud/mail/commit/6c9dc306127fe25f31945b4b2033dc7127371399))
* **signature:** insert "-- " separator for plain text only ([6ffd898](https://github.com/nextcloud/mail/commit/6ffd898e77305b99cfa75017ded9fb6805ed12bf)), closes [#3457](https://github.com/nextcloud/mail/issues/3457)
* the hint that theres no to reciepient ([bb3e1e1](https://github.com/nextcloud/mail/commit/bb3e1e1aad71a352c9a281a96a946d68b523babb))
* **translation:** detect message language in the browser ([d465e6b](https://github.com/nextcloud/mail/commit/d465e6b206eb1e57f444ae8138753f6addaf05eb))
* **TranslationModal:** language code detection ([c7a993b](https://github.com/nextcloud/mail/commit/c7a993bb0bf0be691f5055a1e14b5a33c92761c5))
* **ui:** restore virtual start mailbox too ([7bb70d1](https://github.com/nextcloud/mail/commit/7bb70d1cdec02cccfb44bbf2f7e8008790cde430))


### Features

* add hint that content is ai generated ([45f2e2c](https://github.com/nextcloud/mail/commit/45f2e2c70c8b34072c80800418a2a3fac28c2872))
* **composer:** insert images from Files ([feb8e15](https://github.com/nextcloud/mail/commit/feb8e158d4ab37afac4cce9fb4708619b377e0dd))
* **composer:** reflect the selection in the image picker button ([f82a541](https://github.com/nextcloud/mail/commit/f82a541aab70b154b74b15eee299d5d456112284))
* do not autoreply to noreply@ and no-reply@ senders ([09ef38e](https://github.com/nextcloud/mail/commit/09ef38e503905137cf4600ddab9ae5a60a55c8e4))
* floating composer editor ([e45f36c](https://github.com/nextcloud/mail/commit/e45f36c572b3fcba7ad09a4ec260205dd18b6dee))
* warn users when sending email with empty to field ([71c316e](https://github.com/nextcloud/mail/commit/71c316e21ba287c76157825beb15b87d1db95d32))
