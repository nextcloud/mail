...
* make filter routes available for normal users ([66de20c](https://github.com/nextcloud/mail/commit/66de20cbcd1acedc5589e04be7445a33e0d6eed3))
* **notifications:** Notifier::prepare() threw \InvalidArgumentException which is deprecated ([a7c3f8d](https://github.com/nextcloud/mail/commit/a7c3f8ddf85606cb259d0a90b44579f66d7e8440))



# [4.1.0](https://github.com/nextcloud/mail/compare/v4.1.0-rc1...v4.1.0) (2024-12-18)



# [4.1.0-rc1](https://github.com/nextcloud/mail/compare/v4.1.0-beta3...v4.1.0-rc1) (2024-12-17)


### Bug Fixes

* Disable mail provider ([5c659cc](https://github.com/nextcloud/mail/commit/5c659cce080e47170fd1ba5804833b36b3a3afda))



# [4.1.0-beta3](https://github.com/nextcloud/mail/compare/v4.1.0-beta2...v4.1.0-beta3) (2024-12-17)


### Bug Fixes

* **contactsintegration:** Limit number of matches ([2565925](https://github.com/nextcloud/mail/commit/25659255d76c9c61e861a414b6fc94aca5d113ff))
* **dns:** Update public suffix list ([3d69dce](https://github.com/nextcloud/mail/commit/3d69dce90a30f3bea2cf8ca598eef65fd8e9faa7))
* **dns:** Update public suffix list ([899229c](https://github.com/nextcloud/mail/commit/899229c0a61358500f0b48244e0ef0ceddf1c8db))
* **dns:** Update public suffix list ([1acb6a5](https://github.com/nextcloud/mail/commit/1acb6a5430191da29a50c3994852b88186095bf5))
* **dns:** Update public suffix list ([7f11f12](https://github.com/nextcloud/mail/commit/7f11f12e3d3c3c46ab21b44bd3f63095df778984))
* **dns:** Update public suffix list ([851e20a](https://github.com/nextcloud/mail/commit/851e20aa047658365ef449df2537552d3c85a584))
* **imap:** Consider charset for preview text decoding ([ff31459](https://github.com/nextcloud/mail/commit/ff31459d801713fc4ab806743d5832ce85de53cc))
* **mailto:** Handle BCC recipients only ([e6fa5e8](https://github.com/nextcloud/mail/commit/e6fa5e884f44f75c86e50758fb1ab4310f404fcc))
* new message button misalignment ([d714368](https://github.com/nextcloud/mail/commit/d714368529f9102cf1d0c23afb28464f08bd9ffb))
* **ui:** Add padding to primary evenlope actions ([fb8cc51](https://github.com/nextcloud/mail/commit/fb8cc5146503cd5d0cc48bbdd4c1beed0f6f115c))
* **ui:** Remove padding from recipient bubble ([746f6a1](https://github.com/nextcloud/mail/commit/746f6a18a38af8b695d28bc4bb3a116e7136a6d7))
* **ui:** Restore account quota fetching ([622f478](https://github.com/nextcloud/mail/commit/622f478d4c6b4321249ae5f485c7ef71e668be34))
* **ui:** Restore message/thread styling ([347d417](https://github.com/nextcloud/mail/commit/347d41710d75a6d8aa6ea87753d5295aa79d4fef))
* wrong path for itinerary executable ([70677bc](https://github.com/nextcloud/mail/commit/70677bc6cff8d33e33535c45a5cd7780cc6a0732))



# [4.1.0-beta2](https://github.com/nextcloud/mail/compare/v4.1.0-beta1...v4.1.0-beta2) (2024-11-25)


### Bug Fixes

* disable async vue components ([7054f7b](https://github.com/nextcloud/mail/commit/7054f7ba5679f88e7d62e38a34134f5dd0929ff8))



# [4.1.0-beta1](https://github.com/nextcloud/mail/compare/v4.0.0-beta2...v4.1.0-beta1) (2024-11-22)


### Bug Fixes

* accept avatars with image/vnd.microsoft.icon mime types ([5247509](https://github.com/nextcloud/mail/commit/524750980c0a8b05dc9a32a07cdd6b47924efc0c))
* **avatar:** Use Nextcloud HTTP client for favicons ([2141bac](https://github.com/nextcloud/mail/commit/2141bac5f72aeb0834c849d27ce6b853b7b305be))
* Center envelope header avatar ([1324d1e](https://github.com/nextcloud/mail/commit/1324d1e98fbd1d3e697f511fc027dc4631f96301))
* CKEditor translations ([0097228](https://github.com/nextcloud/mail/commit/0097228110d90d5bd3842eaea67aa28a7e4bc160))
...
* **deps:** bump @nextcloud/vue from 8.19.0 to ^8.20.0 ([3b93bbb](https://github.com/nextcloud/mail/commit/3b93bbbb5499e6533d8bda1de4d87706f61a2a0c))
...
* **deps:** bump bytestream/horde-imap-client from 2.33.2 to ^2.33.3 ([be0a169](https://github.com/nextcloud/mail/commit/be0a16925c7671cc9f43f4d6dacd931f1c339c95))
* **deps:** bump bytestream/horde-stream from 1.7.1 to ^1.7.2 ([24cabd2](https://github.com/nextcloud/mail/commit/24cabd2f63623596d9d2dea099550a42688f30d0))
...
* Junk/NotJunk flags ([abd1b9b](https://github.com/nextcloud/mail/commit/abd1b9bd908d2afd84f4a4f37493ab38c8bbc64c))
...
* **release:** Ignore unnecessary files ([f017e53](https://github.com/nextcloud/mail/commit/f017e535525904cdfdad9f6945c78dbe6fa865ba))
* **release:** Specify release committer ([8b2f7fd](https://github.com/nextcloud/mail/commit/8b2f7fd81d4524d1a3b01db9056c510a2dbac5f9))
...
* bundle with vite ([c55089b](https://github.com/nextcloud/mail/commit/c55089baf99f24e6cfa504ab573f3f76051e8534))
