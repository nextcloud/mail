...
* **avatar:** Use Nextcloud HTTP client for favicons ([05c96e4](https://github.com/nextcloud/mail/commit/05c96e4b9e307f27c925c9c7c729d8654b6c7eef))
* **contactsintegration:** Limit number of search results ([9091ac8](https://github.com/nextcloud/mail/commit/9091ac8ee1de3ff46aee9530e174a996117bfdd0))
* increase default SMTP timeout ([8d2967e](https://github.com/nextcloud/mail/commit/8d2967e20032faca994bdbec9eba7f043671b5d5))
* **PhishingDetection:** empty href ([e5ee8a5](https://github.com/nextcloud/mail/commit/e5ee8a523f9d60b25250e2ca6ca6237dfc1ab8b9))
* **rtl:** userBubble rtl support ([c2a325d](https://github.com/nextcloud/mail/commit/c2a325df09152d7dba12160a466d4f49a08b6571))
* **threading:** Handle threads with duplicate send times ([cd06c18](https://github.com/nextcloud/mail/commit/cd06c187eb914e3f04b2d494debeedf113207679))



## [4.0.2](https://github.com/nextcloud/mail/compare/v4.0.1...v4.0.2) (2024-10-16)


### Bug Fixes

* **iframe:** scroll horizontally in case of overflow ([29c0dee](https://github.com/nextcloud/mail/commit/29c0dee37525762f986bd9d16d609ed72578f0b4))
* **psrlog:** Make the logger compatible with the upcoming bump to psr/log 3 in server ([6ac5b3c](https://github.com/nextcloud/mail/commit/6ac5b3c2877c87a25428ded652a9871a7a00d405))


### Features

* implement periodic full sync job to repair cache inconsistencies ([68776af](https://github.com/nextcloud/mail/commit/68776af74a8ab5dfe7b06f239cb238a2f7175657))



## [4.0.1](https://github.com/nextcloud/mail/compare/v4.0.1-rc1...v4.0.1) (2024-10-01)



## [4.0.1-rc1](https://github.com/nextcloud/mail/compare/v4.0.0...v4.0.1-rc1) (2024-09-30)


### Bug Fixes

* Center envelope header avatar ([dfb3b03](https://github.com/nextcloud/mail/commit/dfb3b036ed57bc9bb25e3a4908eb548c0e9eefd0))
* **imap:** do a single full sync when QRESYNC is enabled ([a4b47f6](https://github.com/nextcloud/mail/commit/a4b47f646e8576ee0bf073759e1c23f20ed39f39))
* **imap:** persist vanished messages immediately on EXAMINE commands ([34113ed](https://github.com/nextcloud/mail/commit/34113ed9956a8f9136450d466287d3b4c2e44b30))
* Revive reply to sender only ([73c8ee9](https://github.com/nextcloud/mail/commit/73c8ee912fef23b4d41a6f3d4c3a24d02da2539f))
* select multiple envelopes by holding shift directly ([a126ab3](https://github.com/nextcloud/mail/commit/a126ab3ef2b132ec3d7648e8e56f0602c9ffb8cc))
* set content type parameters for attachments ([0ab6b31](https://github.com/nextcloud/mail/commit/0ab6b319228cefc498cd7af378b9df5056312939))



# [4.0.0-rc2](https://github.com/nextcloud/mail/compare/v4.0.0-beta2...v4.0.0-rc2) (2024-09-10)
...
* don't loop the users without any provisioning configurations ([d9d2235](https://github.com/nextcloud/mail/commit/d9d22358017fbcd8c519d1a5d7d7650803ae3eee))
